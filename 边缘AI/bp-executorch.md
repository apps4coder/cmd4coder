---
title: "executorch 生产环境最佳实践"
cmd_name: "executorch"
cmd_category: "AI基础设施/边缘AI"
source_page: "[[executorch]]"
domain: "ai-infra"
risk_level: "low"
platforms: ["linux", "darwin"]
tags: ["ai-infra", "risk-low", "linux", "darwin"]
created: "2026-07-28"
source_file: "ai/edge-ai.yaml"
---
...
| 领域 | `ai-infra` |
| 平台 | `linux`, `darwin` |
| 安装 | git clone https://github.com/pytorch/executorch.git && ./install_requirements.sh |
...
[[executorch|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
