...
### 示例 2: 使用采样参数调用 Fireworks

```bash
python -c "from fireworks.client import Fireworks; fw=Fireworks(); r=fw.completion.create(model='accounts/fireworks/models/llama-v3-8b', prompt='Hello', max_tokens=100, temperature=0.5)"
```
