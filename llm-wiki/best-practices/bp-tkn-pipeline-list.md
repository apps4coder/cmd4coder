---
title: "tkn pipeline list 生产环境最佳实践"
cmd_name: "tkn pipeline list"
cmd_category: "容器编排/K8s持续集成"
source_page: "[[tkn-pipeline-list]]"
domain: "container"
risk_level: "low"
...
- **LOW**: Read-only operation; lists pipelines only
...
[[tkn-pipeline-list|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
