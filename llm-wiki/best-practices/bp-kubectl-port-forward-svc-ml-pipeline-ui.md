---
title: "kubectl port-forward svc/ml-pipeline-ui 生产环境最佳实践"
cmd_name: "kubectl port-forward svc/ml-pipeline-ui"
cmd_category: "容器编排/K8s机器学习运维"
source_page: "[[kubectl-port-forward-svc-ml-pipeline-ui]]"
domain: "container"
risk_level: "low"
...
# kubectl port-forward svc/ml-pipeline-ui — 生产环境最佳实践
...
| 安装 | Requires Kubeflow Pipelines deployed |
...
**Forward Pipelines UI to localhost:8080**:
```bash
...
[[kubectl-port-forward-svc-ml-pipeline-ui|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
