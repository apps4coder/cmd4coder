---
title: "external-dns 生产环境最佳实践"
cmd_name: "external-dns"
cmd_category: "容器编排/云原生扩展"
source_page: "[[external-dns]]"
domain: "container"
risk_level: "high"
...
| 领域 | `container` |
| 平台 | `linux`, `darwin` |
| 安装 | 参考 https://kubernetes-sigs.github.io/external-dns/latest/ |
...
- **HIGH**: external-dns 会修改公共 DNS 记录，dry-run 验证后再执行
...
[[external-dns|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
