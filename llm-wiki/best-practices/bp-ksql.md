...
| 领域 | `general` |
| 平台 | `linux`, `darwin` |
| 安装 | 参考 https://docs.confluent.io/platform/current/ksqldb/index.html |
...
- **MEDIUM**: CREATE STREAM/TABLE 会持久化到 Kafka Topic，请确认配置
...
[[ksql|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
