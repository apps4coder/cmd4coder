...
| 领域 | `database` |
| 平台 | `linux`, `darwin` |
| 安装 | apt install redis-server (Ubuntu) 或 yum install redis (CentOS) |
...
- [[bp-redis-cli|redis-cli]]
- [[bp-redis-benchmark|redis-benchmark]]
...
[[redis|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
