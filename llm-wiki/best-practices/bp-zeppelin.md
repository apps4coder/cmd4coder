---
title: "zeppelin 生产环境最佳实践"
cmd_name: "zeppelin"
cmd_category: "大数据/扩展命令"
source_page: "[[zeppelin]]"
domain: "general"
risk_level: "medium"
...
| 领域 | `general` |
| 平台 | `linux`, `darwin` |
| 安装 | 参考 https://zeppelin.apache.org/docs/latest/quickstart/install.html |
...
- **MEDIUM**: Zeppelin 解释器可执行任意代码，请配置认证和权限
...
[[zeppelin|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
