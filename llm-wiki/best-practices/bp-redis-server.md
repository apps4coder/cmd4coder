---
title: "redis-server 生产环境最佳实践"
cmd_name: "redis-server"
cmd_category: "数据库工具/Redis工具"
source_page: "[[redis-server]]"
domain: "database"
risk_level: "high"
...
| 安装 | Install Redis package or build from source |
...
- **HIGH**: Running without authentication exposes data to network
- **MEDIUM**: Default configuration may not be suitable for production
- 数据库连接强制使用 TLS 加密
...
[[redis-server|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
