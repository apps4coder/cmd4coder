---
title: "jenkins-cli 生产环境最佳实践"
cmd_name: "jenkins-cli"
cmd_category: "CI/CD/扩展工具"
source_page: "[[jenkins-cli]]"
domain: "general"
risk_level: "medium"
...
| 领域 | `general` |
| 平台 | `linux`, `darwin` |
| 安装 | 从 Jenkins 管理页下载 jenkins-cli.jar |
...
- **MEDIUM**: jenkins-cli 可安装插件和重启 Jenkins，请保护好凭据
...
- [[bp-gitlab-runner|gitlab-runner]]
- github-actions
...
[[jenkins-cli|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
