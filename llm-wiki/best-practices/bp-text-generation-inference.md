---
title: "text-generation-inference 生产环境最佳实践"
cmd_name: "text-generation-inference"
cmd_category: "AI基础设施/大模型推理"
source_page: "[[text-generation-inference]]"
domain: "ai-infra"
risk_level: "medium"
...
# text-generation-inference — 生产环境最佳实践
...
| 安装 | docker pull ghcr.io/huggingface/text-generation-inference:latest |
...
[[text-generation-inference|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
