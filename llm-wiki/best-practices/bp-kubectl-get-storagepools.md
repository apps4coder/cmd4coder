---
title: "kubectl get storagepools 生产环境最佳实践"
cmd_name: "kubectl get storagepools"
cmd_category: "容器编排/K8s存储增强"
source_page: "[[kubectl-get-storagepools]]"
domain: "container"
risk_level: "low"
...
# kubectl get storagepools — 生产环境最佳实践
...
| 安装 | kubectl with specific storage provider CRDs |
...
- **LOW**: Read-only operation; shows storage pools
...
**List storage pools (depends on storage provider)**:
```bash
...
[[kubectl-get-storagepools|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
