---
title: "stress-ng 生产环境最佳实践"
cmd_name: "stress-ng"
cmd_category: "硬件/性能与调度"
source_page: "[[stress-ng]]"
domain: "general"
risk_level: "high"
platforms: ["linux", "darwin"]
tags: ["general", "risk-high", "linux", "darwin"]
created: "2026-07-28"
source_file: "hardware/perf.yaml"
---
...
| 领域 | `general` |
| 平台 | `linux`, `darwin` |
| 安装 | 包管理器安装，如 sudo apt install stress-ng |
...
- **HIGH**: stress-ng 有大量测试，错误使用会压垮系统
...
[[stress-ng|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
