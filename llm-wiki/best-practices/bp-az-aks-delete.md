---
title: "az aks delete 生产环境最佳实践"
cmd_name: "az aks delete"
cmd_category: "容器编排/K8s云平台工具"
source_page: "[[az-aks-delete]]"
domain: "container"
risk_level: "critical"
...
**Delete AKS cluster with confirmation**:
```bash
...
[[az-aks-delete|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
