---
title: "kubectl apply -f inferenceservice.yaml 生产环境最佳实践"
cmd_name: "kubectl apply -f inferenceservice.yaml"
cmd_category: "容器编排/K8s机器学习运维"
source_page: "[[kubectl-apply-f-inferenceservice-yaml]]"
domain: "container"
risk_level: "medium"
platforms: ["linux", "darwin", "windows"]
tags: ["container", "risk-medium", "linux", "darwin", "windows"]
created: "2026-07-28"
source_file: "container/k8s/k8s-mlops.yaml"
---

# kubectl apply -f inferenceservice.yaml — 生产环境最佳实践
...
| 安装 | kubectl apply -f https://github.com/kserve/kserve/releases/download/v0.11.0/kserve.yaml |
...
- **MEDIUM**: Deploys model serving resources to cluster
...
**Deploy sklearn model inference service**:
```bash
...
[[kubectl-apply-f-inferenceservice-yaml|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
