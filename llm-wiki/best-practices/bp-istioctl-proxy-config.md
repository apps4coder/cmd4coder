---
title: "istioctl proxy-config 生产环境最佳实践"
cmd_name: "istioctl proxy-config"
cmd_category: "容器编排/K8s网络插件"
source_page: "[[istioctl-proxy-config]]"
domain: "container"
risk_level: "low"
...
# istioctl proxy-config — 生产环境最佳实践
...
- **LOW**: Read-only configuration inspection
...
**Show cluster config in production namespace**:
```bash
...
[[istioctl-proxy-config|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
