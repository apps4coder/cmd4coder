---
title: "kubectl patch storageclass 生产环境最佳实践"
cmd_name: "kubectl patch storageclass"
cmd_category: "容器编排/K8s存储增强"
source_page: "[[kubectl-patch-storageclass]]"
domain: "container"
risk_level: "high"
...
# kubectl patch storageclass — 生产环境最佳实践
...
- **MEDIUM**: Changes storage provisioning behavior
- **HIGH**: Setting wrong default may affect new PVCs
...
[[kubectl-patch-storageclass|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
