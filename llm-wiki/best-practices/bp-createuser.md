---
title: "createuser 生产环境最佳实践"
cmd_name: "createuser"
cmd_category: "数据库工具/PostgreSQL工具"
source_page: "[[createuser]]"
domain: "database"
risk_level: "high"
...
- **HIGH**: Creating superuser grants full database control
- **MEDIUM**: Ensure strong passwords for new users
- 数据库连接强制使用 TLS 加密
...
[[createuser|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
