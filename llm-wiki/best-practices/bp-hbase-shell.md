---
title: "hbase shell 生产环境最佳实践"
cmd_name: "hbase shell"
cmd_category: "大数据/扩展工具"
source_page: "[[hbase-shell]]"
domain: "general"
risk_level: "high"
...
- **HIGH**: drop、disable 表会丢失数据，执行前请确认
...
[[hbase-shell|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
