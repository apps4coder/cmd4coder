---
title: "kafka-connect 生产环境最佳实践"
cmd_name: "kafka-connect"
cmd_category: "大数据/扩展工具"
source_page: "[[kafka-connect]]"
domain: "general"
risk_level: "medium"
...
- **MEDIUM**: 连接器配置错误会导致数据重复或丢失，请验证 topic 与 schema
...
[[kafka-connect|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
