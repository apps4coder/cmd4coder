---
title: "kubectl get constraints 生产环境最佳实践"
cmd_name: "kubectl get constraints"
cmd_category: "容器编排/K8s安全工具"
source_page: "[[kubectl-get-constraints]]"
domain: "container"
risk_level: "low"
...
# kubectl get constraints — 生产环境最佳实践
...
| 安装 | kubectl with OPA Gatekeeper installed |
...
- **LOW**: Read-only operation; shows enforced policies
...
**List required labels constraints**:
```bash
...
[[kubectl-get-constraints|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
