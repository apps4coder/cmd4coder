---
title: "gitlab-runner 生产环境最佳实践"
cmd_name: "gitlab-runner"
cmd_category: "CI/CD/扩展工具"
source_page: "[[gitlab-runner]]"
domain: "general"
risk_level: "medium"
platforms: ["linux", "darwin"]
tags: ["general", "risk-medium", "linux", "darwin"]
created: "2026-07-28"
source_file: "cicd/more.yaml"
---

# gitlab-runner — 生产环境最佳实践
...
| 领域 | `general` |
| 平台 | `linux`, `darwin` |
| 安装 | 参考 https://docs.gitlab.com/runner/install/ |
...
- **MEDIUM**: register 需要 GitLab token，请勿泄露
...
[[gitlab-runner|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
