---
title: "kubectl get prometheusrules 生产环境最佳实践"
cmd_name: "kubectl get prometheusrules"
cmd_category: "容器编排/K8s监控日志"
source_page: "[[kubectl-get-prometheusrules]]"
domain: "container"
risk_level: "low"
...
# kubectl get prometheusrules — 生产环境最佳实践
...
- **LOW**: Read-only operation; shows alert rules
...
**List Prometheus rules in monitoring namespace**:
```bash
...
[[kubectl-get-prometheusrules|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
