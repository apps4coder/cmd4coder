---
title: "tkn pipeline start 生产环境最佳实践"
cmd_name: "tkn pipeline start"
cmd_category: "容器编排/K8s持续集成"
source_page: "[[tkn-pipeline-start]]"
domain: "container"
risk_level: "high"
...
| 安装 | Download from https://tekton.dev/docs/cli/ |
...
- **HIGH**: Executes pipeline which may build and deploy applications
- **MEDIUM**: Verify parameters before starting production pipelines
...
[[tkn-pipeline-start|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
