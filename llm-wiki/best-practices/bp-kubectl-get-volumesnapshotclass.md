---
title: "kubectl get volumesnapshotclass 生产环境最佳实践"
cmd_name: "kubectl get volumesnapshotclass"
cmd_category: "容器编排/K8s存储增强"
source_page: "[[kubectl-get-volumesnapshotclass]]"
domain: "container"
risk_level: "low"
...
# kubectl get volumesnapshotclass — 生产环境最佳实践
...
- **LOW**: Read-only operation; shows snapshot provisioners
...
**List all volume snapshot classes**:
```bash
...
[[kubectl-get-volumesnapshotclass|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
