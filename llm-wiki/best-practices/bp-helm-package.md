---
title: "helm package 生产环境最佳实践"
cmd_name: "helm package"
cmd_category: "容器编排/K8s Helm包管理"
source_page: "[[helm-package]]"
domain: "container"
risk_level: "low"
...
- **LOW**: Creates chart archive; no cluster impact
...
**Package chart in mychart directory**:
```bash
...
[[helm-package|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
