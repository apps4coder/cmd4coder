---
title: "bpftrace 生产环境最佳实践"
cmd_name: "bpftrace"
cmd_category: "系统诊断/扩展工具"
source_page: "[[bpftrace]]"
domain: "general"
risk_level: "medium"
platforms: ["linux", "darwin"]
tags: ["general", "risk-medium", "linux", "darwin"]
created: "2026-07-28"
source_file: "diagnostic/more.yaml"
---
...
| 领域 | `general` |
| 平台 | `linux`, `darwin` |
| 安装 | 参考 https://github.com/iovisor/bpftrace/blob/master/INSTALL.md |
...
- **MEDIUM**: bpftrace 在内核运行，脚本错误可能影响性能
...
[[bpftrace|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
