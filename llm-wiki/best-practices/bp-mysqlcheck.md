---
title: "mysqlcheck 生产环境最佳实践"
cmd_name: "mysqlcheck"
cmd_category: "数据库工具/MySQL工具"
source_page: "[[mysqlcheck]]"
domain: "database"
risk_level: "medium"
...
- **MEDIUM**: Repair operations may cause data loss if table is severely corrupted
- **MEDIUM**: Optimize locks tables; may impact performance during operation
- 数据库连接强制使用 TLS 加密
...
[[mysqlcheck|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
