---
title: "mysqldump 生产环境最佳实践"
cmd_name: "mysqldump"
cmd_category: "数据库工具/MySQL工具"
source_page: "[[mysqldump]]"
domain: "database"
risk_level: "medium"
...
- **LOW**: Read-only operation but may impact performance on busy servers
- 数据库连接强制使用 TLS 加密
...
[[mysqldump|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
