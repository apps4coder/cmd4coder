---
title: "kubectl-who-can 生产环境最佳实践"
cmd_name: "kubectl-who-can"
cmd_category: "容器编排/K8s辅助工具"
source_page: "[[kubectl-who-can]]"
domain: "container"
risk_level: "low"
...
| 安装 | kubectl krew install who-can |
...
**查看谁能删除 production 命名空间的 Secret**:
```bash
...
[[kubectl-who-can|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
