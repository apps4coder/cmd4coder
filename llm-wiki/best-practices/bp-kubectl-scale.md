---
title: "kubectl scale 生产环境最佳实践"
cmd_name: "kubectl scale"
cmd_category: "容器编排/Kubernetes命令"
source_page: "[[kubectl-scale]]"
domain: "container"
risk_level: "high"
...
- **HIGH**: Scaling to 0 stops all instances; can cause service outage
- **MEDIUM**: Rapid scaling may cause resource issues
...
[[kubectl-scale|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
