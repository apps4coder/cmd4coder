---
title: "psql (operations) 生产环境最佳实践"
cmd_name: "psql (operations)"
cmd_category: "数据库工具/运维操作"
source_page: "[[psql-operations]]"
domain: "database"
risk_level: "medium"
...
- **MEDIUM**: VACUUM FULL 锁表，pg_terminate_backend 终止连接
- 数据库连接强制使用 TLS 加密
...
- [[bp-pg-dump|pg_dump]]
- [[bp-pg-basebackup|pg_basebackup]]
...
[[psql-operations|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
