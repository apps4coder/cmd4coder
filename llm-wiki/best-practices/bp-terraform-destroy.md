---
title: "terraform destroy 生产环境最佳实践"
cmd_name: "terraform destroy"
cmd_category: "容器编排/K8s配置管理"
source_page: "[[terraform-destroy]]"
domain: "container"
risk_level: "critical"
...
- **CRITICAL**: Permanently deletes all managed infrastructure
- **CRITICAL**: Cannot be undone; backup data before destroying
...
[[terraform-destroy|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
