---
title: "flux bootstrap git 生产环境最佳实践"
cmd_name: "flux bootstrap git"
cmd_category: "容器编排/K8s持续集成"
source_page: "[[flux-bootstrap-git]]"
domain: "container"
risk_level: "high"
...
| 安装 | Download from https://fluxcd.io/flux/installation/ |
...
- **HIGH**: Installs Flux components to cluster; modifies Git repository
- **MEDIUM**: Requires Git write access; creates initial commit
...
[[flux-bootstrap-git|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
