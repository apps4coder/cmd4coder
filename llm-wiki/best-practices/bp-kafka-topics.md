---
title: "kafka-topics 生产环境最佳实践"
cmd_name: "kafka-topics"
cmd_category: "大数据/流处理"
source_page: "[[kafka-topics]]"
domain: "general"
risk_level: "high"
platforms: ["linux", "darwin"]
tags: ["general", "risk-high", "linux", "darwin"]
created: "2026-07-28"
source_file: "bigdata/streaming.yaml"
---

# kafka-topics — 生产环境最佳实践
...
| 领域 | `general` |
| 平台 | `linux`, `darwin` |
| 安装 | 随 Apache Kafka 发行版安装或 brew install kafka (macOS) |
...
- **HIGH**: --delete 删除 Topic 数据不可逆，--alter 分区不可缩容
...
- [[bp-kafka-consumer-groups|kafka-consumer-groups]]
...
[[kafka-topics|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
