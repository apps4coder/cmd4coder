---
title: "superset 生产环境最佳实践"
cmd_name: "superset"
cmd_category: "大数据/扩展命令"
source_page: "[[superset]]"
domain: "general"
risk_level: "medium"
...
| 领域 | `general` |
| 平台 | `linux`, `darwin` |
| 安装 | pip install apache-superset |
...
- **MEDIUM**: 生产环境请关闭 debugger 和 reload，并配置认证
...
[[superset|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
