...
| 领域 | `container` |
| 平台 | `linux`, `darwin` |
| 安装 | 参考 https://flagger.app/install/flagger-install-on-kubernetes/ |
...
- [[bp-argocd|argocd]]
- [[bp-argo-rollouts|argo-rollouts]]
...
[[flagger|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
