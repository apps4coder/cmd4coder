---
title: "ipmitool 生产环境最佳实践"
cmd_name: "ipmitool"
cmd_category: "硬件/远程带外管理"
source_page: "[[ipmitool]]"
domain: "general"
risk_level: "high"
platforms: ["linux", "darwin"]
tags: ["general", "risk-high", "linux", "darwin"]
created: "2026-07-28"
source_file: "hardware/ipmi.yaml"
---
...
| 领域 | `general` |
| 平台 | `linux`, `darwin` |
| 安装 | 包管理器安装，如 sudo apt install ipmitool |
...
[[ipmitool|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
