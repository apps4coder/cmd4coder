---
title: "fluentd -c 生产环境最佳实践"
cmd_name: "fluentd -c"
cmd_category: "容器编排/K8s监控日志"
source_page: "[[fluentd-c]]"
domain: "container"
risk_level: "medium"
...
| 安装 | gem install fluentd or use td-agent package |
...
- **MEDIUM**: Incorrect config may cause log loss or performance issues
...
**Start Fluentd with config file**:
```bash
...
[[fluentd-c|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
