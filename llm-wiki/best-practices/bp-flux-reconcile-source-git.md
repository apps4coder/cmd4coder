---
title: "flux reconcile source git 生产环境最佳实践"
cmd_name: "flux reconcile source git"
cmd_category: "容器编排/K8s持续集成"
source_page: "[[flux-reconcile-source-git]]"
domain: "container"
risk_level: "medium"
...
# flux reconcile source git — 生产环境最佳实践
...
- **MEDIUM**: Triggers immediate sync from Git; may deploy changes
...
**Reconcile source in production namespace**:
```bash
...
[[flux-reconcile-source-git|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
