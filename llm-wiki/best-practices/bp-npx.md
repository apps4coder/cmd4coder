...
- **MEDIUM**: Downloads and executes code from npm registry
...
**Create React app without global install**:
```bash
...
[[npx|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
