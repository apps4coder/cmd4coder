---
title: "kubectl describe 生产环境最佳实践"
cmd_name: "kubectl describe"
cmd_category: "容器编排/Kubernetes命令"
source_page: "[[kubectl-describe]]"
domain: "container"
risk_level: "low"
...
**Describe service in production namespace**:
```bash
...
[[kubectl-describe|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
