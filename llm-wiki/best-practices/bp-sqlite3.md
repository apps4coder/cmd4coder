...
| 安装 | 多数 Linux/macOS 预装，或从 https://sqlite.org/download.html 安装 |
...
- **LOW**: SQLite 为文件级数据库，请确保有文件写权限并定期备份
- 数据库连接强制使用 TLS 加密
...
[[sqlite3|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
