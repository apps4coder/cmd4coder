---
title: "calicoctl delete networkpolicy 生产环境最佳实践"
cmd_name: "calicoctl delete networkpolicy"
cmd_category: "容器编排/K8s网络插件"
source_page: "[[calicoctl-delete-networkpolicy]]"
domain: "container"
risk_level: "critical"
platforms: ["linux", "darwin", "windows"]
tags: ["container", "risk-critical", "linux", "darwin", "windows"]
created: "2026-07-28"
source_file: "container/k8s/k8s-network.yaml"
---

# calicoctl delete networkpolicy — 生产环境最佳实践
...
| 安装 | Download from https://github.com/projectcalico/calico/releases |
...
- **HIGH**: Removing policy may expose services to unauthorized access
- **CRITICAL**: Deleting critical policies affects security posture
...
**Delete specific network policy**:
```bash
...
[[calicoctl-delete-networkpolicy|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
