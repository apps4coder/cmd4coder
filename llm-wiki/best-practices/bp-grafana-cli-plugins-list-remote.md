---
title: "grafana-cli plugins list-remote 生产环境最佳实践"
cmd_name: "grafana-cli plugins list-remote"
cmd_category: "容器编排/K8s监控日志"
source_page: "[[grafana-cli-plugins-list-remote]]"
domain: "container"
risk_level: "low"
...
# grafana-cli plugins list-remote — 生产环境最佳实践
...
- **LOW**: Read-only operation; lists available plugins
...
[[grafana-cli-plugins-list-remote|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
