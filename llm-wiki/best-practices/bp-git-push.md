---
title: "git push 生产环境最佳实践"
cmd_name: "git push"
cmd_category: "版本控制/Git命令"
source_page: "[[git-push]]"
domain: "vcs"
risk_level: "high"
...
- **HIGH**: 使用--force可能覆盖他人的提交，务必谨慎
- **HIGH**: 涉及重写历史或删除的操作不可逆，建议先备份分支或创建保护规则。
...
[[git-push|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
