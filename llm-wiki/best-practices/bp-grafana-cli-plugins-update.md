---
title: "grafana-cli plugins update 生产环境最佳实践"
cmd_name: "grafana-cli plugins update"
cmd_category: "容器编排/K8s监控日志"
source_page: "[[grafana-cli-plugins-update]]"
domain: "container"
risk_level: "medium"
...
# grafana-cli plugins update — 生产环境最佳实践
...
- **MEDIUM**: Plugin updates may break dashboards
...
[[grafana-cli-plugins-update|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
