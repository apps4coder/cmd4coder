...
tags: ["observability", "risk-medium", "linux", "darwin", "windows"]
created: "2026-07-28"
source_file: "diagnostic/arthas.yaml"
---
...
| 安装 | Download from https://arthas.aliyun.com/ |
...
- **MEDIUM**: Attaches to running JVM; may impact performance
...
**Start Arthas and select process interactively**:
```bash
...
[[arthas|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
