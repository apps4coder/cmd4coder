...
tags: ["container", "risk-critical", "linux", "darwin"]
created: "2026-07-28"
...
| 领域 | `container` |
| 平台 | `linux`, `darwin` |
| 安装 | 参考 https://developer.hashicorp.com/vault/downloads |
...
- **CRITICAL**: Vault 管理敏感凭据，错误策略或 root token 泄露会造成严重安全事故
...
[[vault|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
