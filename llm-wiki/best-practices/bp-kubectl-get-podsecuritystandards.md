---
title: "kubectl get podsecuritystandards 生产环境最佳实践"
cmd_name: "kubectl get podsecuritystandards"
cmd_category: "容器编排/K8s安全工具"
source_page: "[[kubectl-get-podsecuritystandards]]"
domain: "container"
risk_level: "medium"
...
# kubectl get podsecuritystandards — 生产环境最佳实践
...
| 安装 | kubectl built-in command (v1.23+) |
...
- **MEDIUM**: Changing enforce level may prevent pods from starting
...
**Check PodSecurity enforce level on all namespaces**:
```bash
...
[[kubectl-get-podsecuritystandards|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
