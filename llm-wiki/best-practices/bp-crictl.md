...
| 领域 | `container` |
| 平台 | `linux`, `darwin` |
| 安装 | 参考 https://github.com/kubernetes-sigs/cri-tools/blob/master/docs/crictl.md |
...
- **MEDIUM**: crictl 可直接删除运行中容器，生产环境请谨慎
...
[[crictl|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
