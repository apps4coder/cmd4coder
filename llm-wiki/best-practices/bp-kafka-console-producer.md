---
title: "kafka-console-producer 生产环境最佳实践"
cmd_name: "kafka-console-producer"
cmd_category: "大数据/Kafka工具"
source_page: "[[kafka-console-producer]]"
domain: "general"
risk_level: "low"
...
# kafka-console-producer — 生产环境最佳实践
...
- **LOW**: 向生产 Topic 发送测试数据可能污染业务数据，请注意环境
...
[[kafka-console-producer|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
