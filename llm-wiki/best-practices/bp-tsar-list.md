---
title: "tsar --list 生产环境最佳实践"
cmd_name: "tsar --list"
cmd_category: "诊断工具/系统诊断"
source_page: "[[tsar-list]]"
...
- **LOW**: Read-only operation; no risks
...
**Show all available monitoring modules**:
```bash
tsar --list
```
...
[[tsar-list|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
