---
title: "heapdump 生产环境最佳实践"
cmd_name: "heapdump"
cmd_category: "诊断工具/Java诊断"
source_page: "[[heapdump]]"
domain: "observability"
risk_level: "high"
platforms: ["linux", "darwin", "windows"]
tags: ["observability", "risk-high", "linux", "darwin", "windows"]
created: "2026-07-28"
...
- **HIGH**: May pause application; large dump files
- **HIGH**: 生成的诊断文件可能包含敏感信息，请注意存储位置与访问权限。
...
[[heapdump|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
