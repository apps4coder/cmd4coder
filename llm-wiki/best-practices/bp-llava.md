...
| 领域 | `ai-infra` |
| 平台 | `linux`, `darwin` |
| 安装 | git clone https://github.com/haotian-liu/LLaVA.git |
...
- [[bp-clip|clip]]
- [[bp-transformers-pipeline|transformers-pipeline]]
...
[[llava|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
