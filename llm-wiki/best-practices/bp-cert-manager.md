---
title: "cert-manager 生产环境最佳实践"
cmd_name: "cert-manager"
cmd_category: "容器编排/云原生扩展"
source_page: "[[cert-manager]]"
domain: "container"
risk_level: "medium"
...
| 领域 | `container` |
| 平台 | `linux`, `darwin` |
| 安装 | 参考 https://cert-manager.io/docs/reference/cmctl/ |
...
- **MEDIUM**: 手动 renew 或删除证书可能导致服务 TLS 中断
...
[[cert-manager|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
