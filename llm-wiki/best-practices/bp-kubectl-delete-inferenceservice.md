---
title: "kubectl delete inferenceservice 生产环境最佳实践"
cmd_name: "kubectl delete inferenceservice"
cmd_category: "容器编排/K8s机器学习运维"
source_page: "[[kubectl-delete-inferenceservice]]"
domain: "container"
risk_level: "high"
...
# kubectl delete inferenceservice — 生产环境最佳实践
...
| 安装 | Requires KServe CRDs installed |
...
- **HIGH**: Permanently deletes model serving resources
- **HIGH**: 删除推理服务会中断线上流量，建议先完成流量切换或灰度验证。
...
**Delete sklearn-iris inference service**:
```bash
...
[[kubectl-delete-inferenceservice|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
