---
title: "ansible-pull 生产环境最佳实践"
cmd_name: "ansible-pull"
cmd_category: "容器编排/K8s配置管理"
source_page: "[[ansible-pull]]"
domain: "container"
risk_level: "high"
...
- **MEDIUM**: Pulls and executes remote playbooks
- **HIGH**: Ensure repository is trusted
...
**Pull and run playbooks from Git**:
```bash
...
[[ansible-pull|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
