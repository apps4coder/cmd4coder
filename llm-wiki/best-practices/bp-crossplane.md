---
title: "crossplane 生产环境最佳实践"
cmd_name: "crossplane"
cmd_category: "容器编排/云原生扩展"
source_page: "[[crossplane]]"
domain: "container"
risk_level: "medium"
...
| 领域 | `container` |
| 平台 | `linux`, `darwin` |
| 安装 | 参考 https://docs.crossplane.io/latest/software/install/ |
...
- **MEDIUM**: Managed Resources 会创建真实云资源，请确认 provider 配置
...
[[crossplane|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
