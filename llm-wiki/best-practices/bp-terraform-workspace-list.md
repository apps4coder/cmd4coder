---
title: "terraform workspace list 生产环境最佳实践"
cmd_name: "terraform workspace list"
cmd_category: "容器编排/K8s配置管理"
source_page: "[[terraform-workspace-list]]"
domain: "container"
risk_level: "low"
...
# terraform workspace list — 生产环境最佳实践
...
- **LOW**: Read-only operation; lists workspaces
...
[[terraform-workspace-list|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
