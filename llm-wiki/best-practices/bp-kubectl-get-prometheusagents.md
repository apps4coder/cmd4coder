---
title: "kubectl get prometheusagents 生产环境最佳实践"
cmd_name: "kubectl get prometheusagents"
cmd_category: "容器编排/K8s监控日志"
source_page: "[[kubectl-get-prometheusagents]]"
domain: "container"
risk_level: "low"
...
# kubectl get prometheusagents — 生产环境最佳实践
...
| 安装 | kubectl with Prometheus Operator v0.64+ |
...
- **LOW**: Read-only operation; requires Prometheus Agent CRDs
...
**List Prometheus agents in monitoring namespace**:
```bash
...
[[kubectl-get-prometheusagents|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
