---
title: "helm env 生产环境最佳实践"
cmd_name: "helm env"
cmd_category: "容器编排/K8s Helm包管理"
source_page: "[[helm-env]]"
domain: "container"
risk_level: "low"
...
- **LOW**: Read-only environment information
...
**Show Helm environment variables and paths**:
```bash
helm env
```
...
[[helm-env|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
