---
title: "promtail 生产环境最佳实践"
cmd_name: "promtail"
cmd_category: "容器编排/云原生扩展"
source_page: "[[promtail]]"
domain: "container"
risk_level: "medium"
...
| 领域 | `container` |
| 平台 | `linux`, `darwin` |
| 安装 | 参考 https://grafana.com/docs/loki/latest/send-data/promtail/installation/ |
...
- **MEDIUM**: 错误的标签配置会导致日志无法查询或 cardinality 爆炸
...
[[promtail|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
