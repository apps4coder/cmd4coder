---
title: "pt-query-digest 生产环境最佳实践"
cmd_name: "pt-query-digest"
cmd_category: "数据库工具/扩展命令"
source_page: "[[pt-query-digest]]"
domain: "database"
risk_level: "low"
platforms: ["linux", "darwin"]
tags: ["database", "risk-low", "linux", "darwin"]
created: "2026-07-28"
source_file: "database/more.yaml"
---

# pt-query-digest — 生产环境最佳实践
...
| 领域 | `database` |
| 平台 | `linux`, `darwin` |
| 安装 | 参考 https://docs.percona.com/percona-toolkit/installation.html |
...
[[pt-query-digest|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
