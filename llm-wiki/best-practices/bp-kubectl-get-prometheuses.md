---
title: "kubectl get prometheuses 生产环境最佳实践"
cmd_name: "kubectl get prometheuses"
cmd_category: "容器编排/K8s监控日志"
source_page: "[[kubectl-get-prometheuses]]"
domain: "container"
risk_level: "low"
...
# kubectl get prometheuses — 生产环境最佳实践
...
- **LOW**: Read-only operation; requires Prometheus Operator
...
**List Prometheus instances in monitoring namespace**:
```bash
...
[[kubectl-get-prometheuses|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
