---
title: "telepresence 生产环境最佳实践"
cmd_name: "telepresence"
cmd_category: "容器编排/云原生扩展二"
source_page: "[[telepresence]]"
domain: "container"
risk_level: "high"
...
| 领域 | `container` |
| 平台 | `linux`, `darwin` |
| 安装 | 参考 https://www.telepresence.io/docs/latest/install/ |
...
- **HIGH**: intercept 会将生产流量引到本地，请确认目标环境和回滚策略
...
[[telepresence|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
