---
title: "kubectl get podmonitors 生产环境最佳实践"
cmd_name: "kubectl get podmonitors"
cmd_category: "容器编排/K8s监控日志"
source_page: "[[kubectl-get-podmonitors]]"
domain: "container"
risk_level: "low"
...
# kubectl get podmonitors — 生产环境最佳实践
...
- **LOW**: Read-only operation; shows pod monitoring configs
...
**List PodMonitors in monitoring namespace**:
```bash
...
[[kubectl-get-podmonitors|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
