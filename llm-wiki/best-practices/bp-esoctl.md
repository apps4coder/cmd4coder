...
| 领域 | `container` |
| 平台 | `linux`, `darwin` |
| 安装 | kubectl krew install external-secrets |
...
- **MEDIUM**: 错误的 SecretStore 会同步错误凭据，请确认 provider 配置
...
[[esoctl|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
