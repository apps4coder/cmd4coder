---
title: "apt remove 生产环境最佳实践"
cmd_name: "apt remove"
cmd_category: "操作系统/Ubuntu系统命令"
source_page: "[[apt-remove]]"
domain: "system"
risk_level: "high"
platforms: ["linux"]
...
- **HIGH**: Removing system packages may break system
- **HIGH**: 操作前建议确认目标对象，并在非生产环境验证后再执行。
...
[[apt-remove|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
