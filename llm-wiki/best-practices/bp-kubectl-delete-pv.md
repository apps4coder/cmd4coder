---
title: "kubectl delete pv 生产环境最佳实践"
cmd_name: "kubectl delete pv"
cmd_category: "容器编排/K8s存储增强"
source_page: "[[kubectl-delete-pv]]"
domain: "container"
risk_level: "critical"
...
- **CRITICAL**: Permanently deletes storage volumes
- **HIGH**: Ensure no PVCs are bound before deletion
...
**Delete orphaned persistent volume**:
```bash
...
[[kubectl-delete-pv|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
