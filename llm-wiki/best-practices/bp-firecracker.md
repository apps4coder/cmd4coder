---
title: "firecracker 生产环境最佳实践"
cmd_name: "firecracker"
cmd_category: "容器编排/云原生扩展二"
source_page: "[[firecracker]]"
domain: "container"
risk_level: "medium"
...
| 领域 | `container` |
| 平台 | `linux`, `darwin` |
| 安装 | 参考 https://github.com/firecracker-microvm/firecracker |
...
- **MEDIUM**: Firecracker 直接运行微虚拟机，需配置安全组和资源限制
...
[[firecracker|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
