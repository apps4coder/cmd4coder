---
title: "dnsrecon 生产环境最佳实践"
cmd_name: "dnsrecon"
cmd_category: "网络工具/扩展工具"
source_page: "[[dnsrecon]]"
domain: "network"
risk_level: "medium"
...
| 领域 | `network` |
| 平台 | `linux`, `darwin` |
| 安装 | 参考 https://github.com/darkoperator/dnsrecon |
...
- **MEDIUM**: 大量 DNS 查询可能被目标视为扫描，请控制速率
...
[[dnsrecon|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
