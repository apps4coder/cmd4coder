---
title: "telepresence connect 生产环境最佳实践"
cmd_name: "telepresence connect"
cmd_category: "容器编排/K8s开发调试"
source_page: "[[telepresence-connect]]"
domain: "container"
risk_level: "medium"
...
- **MEDIUM**: Creates network proxy to cluster
- **LOW**: Read-only connection by default
...
**Connect to production namespace**:
```bash
...
[[telepresence-connect|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
