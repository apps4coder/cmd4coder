---
title: "conftest 生产环境最佳实践"
cmd_name: "conftest"
cmd_category: "网络工具/安全扫描"
source_page: "[[conftest]]"
domain: "network"
risk_level: "low"
...
| 领域 | `network` |
| 平台 | `linux`, `darwin` |
| 安装 | brew install conftest (macOS) 或 go install github.com/open-policy-agent/conftest@latest |
...
[[conftest|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
