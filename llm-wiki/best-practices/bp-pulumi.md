...
| 安装 | 参考 https://www.pulumi.com/docs/install/ |
...
- **HIGH**: pulumi up/destroy 会创建或删除真实云资源，请在确认变更范围后执行
- **HIGH**: 基础设施变更会创建或销毁真实云资源，请在 preview 确认 diff 后再执行 up/destroy。
...
[[pulumi|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
