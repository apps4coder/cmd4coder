---
title: "buildkite-agent 生产环境最佳实践"
cmd_name: "buildkite-agent"
cmd_category: "CI-CD/平台工具"
source_page: "[[buildkite-agent]]"
domain: "cicd"
risk_level: "medium"
...
| 领域 | `cicd` |
| 平台 | `linux`, `darwin` |
| 安装 | brew install buildkite/buildkite/buildkite-agent (macOS) 或参见 buildkite.com/docs |
...
[[buildkite-agent|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
