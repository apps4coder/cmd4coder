---
title: "tidb-ctl 生产环境最佳实践"
cmd_name: "tidb-ctl"
cmd_category: "数据库工具/扩展工具"
source_page: "[[tidb-ctl]]"
domain: "database"
risk_level: "medium"
...
| 领域 | `database` |
| 平台 | `linux`, `darwin` |
| 安装 | 参考 https://docs.pingcap.com/tidb/stable/tidb-control |
...
- **MEDIUM**: 直接操作 TiDB 内部元数据可能导致不一致，请谨慎
- 数据库连接强制使用 TLS 加密
...
[[tidb-ctl|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
