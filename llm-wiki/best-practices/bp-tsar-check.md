---
title: "tsar --check 生产环境最佳实践"
cmd_name: "tsar --check"
cmd_category: "诊断工具/系统诊断"
source_page: "[[tsar-check]]"
domain: "observability"
risk_level: "low"
platforms: ["linux"]
tags: ["observability", "risk-low", "linux"]
created: "2026-07-28"
source_file: "diagnostic/tsar.yaml"
---
...
| 领域 | `observability` |
| 平台 | `linux` |
| 安装 | Install from https://github.com/alibaba/tsar |
...
**Verify tsar installation and configuration**:
```bash
tsar --check
```
...
[[tsar-check|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
