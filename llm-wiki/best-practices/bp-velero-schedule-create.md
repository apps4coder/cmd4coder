---
title: "velero schedule create 生产环境最佳实践"
cmd_name: "velero schedule create"
cmd_category: "容器编排/K8s备份恢复"
source_page: "[[velero-schedule-create]]"
domain: "container"
risk_level: "low"
...
# velero schedule create — 生产环境最佳实践
...
- **LOW**: Creates scheduled task; actual backups are read-only
...
**Schedule hourly backup for production namespace**:
```bash
...
[[velero-schedule-create|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
