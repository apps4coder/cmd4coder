---
title: "kubectl get serviceaccounts 生产环境最佳实践"
cmd_name: "kubectl get serviceaccounts"
cmd_category: "容器编排/K8s安全工具"
source_page: "[[kubectl-get-serviceaccounts]]"
domain: "container"
risk_level: "low"
...
# kubectl get serviceaccounts — 生产环境最佳实践
...
- **LOW**: Read-only operation; shows service account identities
...
**List service accounts in production namespace**:
```bash
...
[[kubectl-get-serviceaccounts|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
