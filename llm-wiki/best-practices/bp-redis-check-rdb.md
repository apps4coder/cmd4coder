---
title: "redis-check-rdb 生产环境最佳实践"
cmd_name: "redis-check-rdb"
cmd_category: "数据库工具/Redis工具"
source_page: "[[redis-check-rdb]]"
domain: "database"
risk_level: "low"
...
- **LOW**: Read-only operation; safe to use
- 数据库连接强制使用 TLS 加密
...
[[redis-check-rdb|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
