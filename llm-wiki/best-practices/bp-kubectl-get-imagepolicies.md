---
title: "kubectl get imagepolicies 生产环境最佳实践"
cmd_name: "kubectl get imagepolicies"
cmd_category: "容器编排/K8s安全工具"
source_page: "[[kubectl-get-imagepolicies]]"
domain: "container"
risk_level: "low"
...
# kubectl get imagepolicies — 生产环境最佳实践
...
| 安装 | kubectl with OPA/Gatekeeper or similar tools |
...
- **LOW**: Read-only operation; shows image validation rules
...
**List image policies in production namespace**:
```bash
...
[[kubectl-get-imagepolicies|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
