---
title: "kubectl get inferenceservices 生产环境最佳实践"
cmd_name: "kubectl get inferenceservices"
cmd_category: "容器编排/K8s机器学习运维"
source_page: "[[kubectl-get-inferenceservices]]"
domain: "container"
risk_level: "low"
...
# kubectl get inferenceservices — 生产环境最佳实践
...
**List all inference services in current namespace**:
```bash
kubectl get isvc
```
...
[[kubectl-get-inferenceservices|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
