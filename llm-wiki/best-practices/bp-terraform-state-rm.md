---
title: "terraform state rm 生产环境最佳实践"
cmd_name: "terraform state rm"
cmd_category: "容器编排/K8s配置管理"
source_page: "[[terraform-state-rm]]"
domain: "container"
risk_level: "high"
platforms: ["linux", "darwin", "windows"]
tags: ["container", "risk-high", "linux", "darwin", "windows"]
created: "2026-07-28"
source_file: "container/k8s/k8s-config.yaml"
---

# terraform state rm — 生产环境最佳实践
...
| 安装 | Download from https://www.terraform.io/downloads |
...
- **HIGH**: Removes from state; resource remains in infrastructure
- **HIGH**: Backup state before removal
...
[[terraform-state-rm|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
