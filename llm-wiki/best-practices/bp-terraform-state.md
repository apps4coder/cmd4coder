---
title: "terraform state 生产环境最佳实践"
cmd_name: "terraform state"
cmd_category: "云平台/配置管理"
source_page: "[[terraform-state]]"
domain: "cloud"
risk_level: "high"
...
- **HIGH**: state rm 导致资源脱离管理，state mv 错误可能丢失追踪
...
- [[bp-terraform-import|terraform import]]
...
[[terraform-state|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
