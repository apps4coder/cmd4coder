---
title: "kafka-reassign-partitions.sh 生产环境最佳实践"
cmd_name: "kafka-reassign-partitions.sh"
cmd_category: "大数据/扩展命令"
source_page: "[[kafka-reassign-partitions-sh]]"
domain: "general"
risk_level: "high"
...
# kafka-reassign-partitions.sh — 生产环境最佳实践
...
- **HIGH**: 分区重分配会移动大量数据并影响性能，请先在低峰期验证
...
[[kafka-reassign-partitions-sh|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
