---
title: "kata-runtime 生产环境最佳实践"
cmd_name: "kata-runtime"
cmd_category: "容器编排/云原生扩展二"
source_page: "[[kata-runtime]]"
domain: "container"
risk_level: "medium"
...
| 领域 | `container` |
| 平台 | `linux`, `darwin` |
| 安装 | 参考 https://github.com/kata-containers/kata-containers/blob/main/docs/install/README.md |
...
- [[bp-containerd|containerd]]
- [[bp-firecracker|firecracker]]
...
[[kata-runtime|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
