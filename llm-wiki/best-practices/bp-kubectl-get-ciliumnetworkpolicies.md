---
title: "kubectl get ciliumnetworkpolicies 生产环境最佳实践"
cmd_name: "kubectl get ciliumnetworkpolicies"
cmd_category: "容器编排/K8s网络插件"
source_page: "[[kubectl-get-ciliumnetworkpolicies]]"
domain: "container"
risk_level: "low"
...
# kubectl get ciliumnetworkpolicies — 生产环境最佳实践
...
| 安装 | kubectl with Cilium installed |
...
- **LOW**: Read-only operation; shows advanced policies
...
**List Cilium policies in production namespace**:
```bash
...
[[kubectl-get-ciliumnetworkpolicies|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
