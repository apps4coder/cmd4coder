---
title: "systemctl status fluentd 生产环境最佳实践"
cmd_name: "systemctl status fluentd"
cmd_category: "容器编排/K8s监控日志"
source_page: "[[systemctl-status-fluentd]]"
domain: "container"
risk_level: "medium"
platforms: ["linux"]
...
# systemctl status fluentd — 生产环境最佳实践
...
- **MEDIUM**: Restarting Fluentd causes log collection interruption
...
[[systemctl-status-fluentd|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
