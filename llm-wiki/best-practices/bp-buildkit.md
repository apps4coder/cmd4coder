---
title: "buildkit 生产环境最佳实践"
cmd_name: "buildkit"
cmd_category: "容器编排/云原生扩展"
source_page: "[[buildkit]]"
domain: "container"
risk_level: "medium"
...
| 领域 | `container` |
| 平台 | `linux`, `darwin` |
| 安装 | 参考 https://github.com/moby/buildkit/blob/master/README.md |
...
- **MEDIUM**: 构建会执行 Dockerfile 中的指令，请审查基础镜像和命令
...
[[buildkit|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
