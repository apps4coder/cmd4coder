---
title: "mvn clean 生产环境最佳实践"
cmd_name: "mvn clean"
cmd_category: "构建工具/Maven"
source_page: "[[mvn-clean]]"
domain: "build"
risk_level: "high"
platforms: ["linux", "darwin", "windows"]
tags: ["build", "risk-high", "linux", "darwin", "windows"]
created: "2026-07-28"
source_file: "build-tools/maven.yaml"
---
...
- **HIGH**: 会删除 target 目录及其所有内容，不可恢复
- **HIGH**: 安装到系统目录可能影响其他项目，建议使用本地前缀或在隔离环境中执行。
...
[[mvn-clean|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
