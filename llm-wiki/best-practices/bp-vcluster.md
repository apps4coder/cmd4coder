---
title: "vcluster 生产环境最佳实践"
cmd_name: "vcluster"
cmd_category: "容器编排/云原生扩展二"
source_page: "[[vcluster]]"
domain: "container"
risk_level: "medium"
...
| 领域 | `container` |
| 平台 | `linux`, `darwin` |
| 安装 | 参考 https://www.vcluster.com/docs/getting-started/install |
...
- **MEDIUM**: vcluster 共享宿主机集群资源，请注意配额和权限
...
[[vcluster|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
