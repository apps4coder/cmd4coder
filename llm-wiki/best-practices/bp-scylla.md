...
| 领域 | `database` |
| 平台 | `linux`, `darwin` |
| 安装 | 参考 https://opensource.docs.scylladb.com/stable/getting-started/installation.html |
...
- **MEDIUM**: Scylla 是系统级服务，启动前请确认资源配置
- 数据库连接强制使用 TLS 加密
...
- [[bp-cqlsh|cqlsh]]
- [[bp-cassandra-stress|cassandra-stress]]
...
[[scylla|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
