...
| 领域 | `cicd` |
| 平台 | `linux`, `darwin` |
| 安装 | brew install drone-cli (macOS) 或 go install github.com/drone/drone-cli@latest |
...
[[drone|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
