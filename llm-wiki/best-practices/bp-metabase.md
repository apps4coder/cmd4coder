---
title: "metabase 生产环境最佳实践"
cmd_name: "metabase"
cmd_category: "大数据/扩展命令"
source_page: "[[metabase]]"
domain: "general"
risk_level: "medium"
...
| 领域 | `general` |
| 平台 | `linux`, `darwin` |
| 安装 | 参考 https://www.metabase.com/start/oss/ |
...
- **MEDIUM**: Metabase 会连接数据库，请使用只读账户并限制权限
...
[[metabase|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
