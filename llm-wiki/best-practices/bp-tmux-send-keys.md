---
title: "tmux send-keys 生产环境最佳实践"
cmd_name: "tmux send-keys"
cmd_category: "Shell脚本/终端复用"
source_page: "[[tmux-send-keys]]"
domain: "shell"
risk_level: "medium"
platforms: ["linux", "darwin"]
tags: ["shell", "risk-medium", "linux", "darwin"]
created: "2026-07-28"
source_file: "shell/tmux.yaml"
---

# tmux send-keys — 生产环境最佳实践
...
- [[bp-tmux|tmux]]
- [[bp-tmux-split-window|tmux split-window]]
...
[[tmux-send-keys|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
