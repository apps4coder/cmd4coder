---
title: "kubectl get endpointslices 生产环境最佳实践"
cmd_name: "kubectl get endpointslices"
cmd_category: "容器编排/K8s网络插件"
source_page: "[[kubectl-get-endpointslices]]"
domain: "container"
risk_level: "low"
...
# kubectl get endpointslices — 生产环境最佳实践
...
- **LOW**: Read-only operation; shows service topology
...
**List endpoint slices in production namespace**:
```bash
...
[[kubectl-get-endpointslices|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
