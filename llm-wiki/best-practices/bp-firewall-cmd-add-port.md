---
title: "firewall-cmd --add-port 生产环境最佳实践"
cmd_name: "firewall-cmd --add-port"
cmd_category: "操作系统/CentOS系统命令"
source_page: "[[firewall-cmd-add-port]]"
domain: "system"
risk_level: "medium"
platforms: ["linux"]
...
# firewall-cmd --add-port — 生产环境最佳实践
...
| 领域 | `system` |
| 平台 | `linux` |
| 安装 | Pre-installed on CentOS/RHEL 7+ |
...
- **MEDIUM**: Opening ports may expose services to network
...
[[firewall-cmd-add-port|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
