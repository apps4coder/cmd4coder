---
title: "kubectl apply 生产环境最佳实践"
cmd_name: "kubectl apply"
cmd_category: "容器编排/Kubernetes命令"
source_page: "[[kubectl-apply]]"
domain: "container"
risk_level: "high"
...
- **HIGH**: Modifies cluster resources; can cause service disruption
- **MEDIUM**: Always review YAML files before applying
...
[[kubectl-apply|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
