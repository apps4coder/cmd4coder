---
title: "clickhouse-client 生产环境最佳实践"
cmd_name: "clickhouse-client"
cmd_category: "数据库工具/时序与OLAP"
source_page: "[[clickhouse-client]]"
domain: "database"
risk_level: "medium"
platforms: ["linux", "darwin"]
tags: ["database", "risk-medium", "linux", "darwin"]
created: "2026-07-28"
source_file: "database/timeseries.yaml"
---

# clickhouse-client — 生产环境最佳实践
...
- **MEDIUM**: ClickHouse 查询可能扫描亿级数据，请关注内存和 IO 消耗
- 数据库连接强制使用 TLS 加密
...
[[clickhouse-client|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
