---
title: "kfctl delete 生产环境最佳实践"
cmd_name: "kfctl delete"
cmd_category: "容器编排/K8s机器学习运维"
source_page: "[[kfctl-delete]]"
domain: "container"
risk_level: "critical"
...
- **CRITICAL**: Deletes entire Kubeflow installation
- **HIGH**: May cause data loss if storage is deleted
...
[[kfctl-delete|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
