---
title: "argocd app create 生产环境最佳实践"
cmd_name: "argocd app create"
cmd_category: "容器编排/K8s持续集成"
source_page: "[[argocd-app-create]]"
domain: "container"
risk_level: "high"
platforms: ["linux", "darwin", "windows"]
tags: ["container", "risk-high", "linux", "darwin", "windows"]
created: "2026-07-28"
source_file: "container/k8s/k8s-cicd.yaml"
---

# argocd app create — 生产环境最佳实践
...
| 安装 | Download from https://argo-cd.readthedocs.io/en/stable/cli_installation/ |
...
- **HIGH**: Creates application that will deploy resources to cluster
- **MEDIUM**: Verify repository and path before creating
...
[[argocd-app-create|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
