...
| 领域 | `network` |
| 平台 | `linux`, `darwin` |
| 安装 | brew install opa (macOS) 或 curl -L -o opa https://openpolicyagent.org/downloads/latest/opa_linux_amd64_static |
...
[[opa|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
