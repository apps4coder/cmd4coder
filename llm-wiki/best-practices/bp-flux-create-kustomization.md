---
title: "flux create kustomization 生产环境最佳实践"
cmd_name: "flux create kustomization"
cmd_category: "CI-CD/GitOps"
source_page: "[[flux-create-kustomization]]"
domain: "cicd"
risk_level: "medium"
...
# flux create kustomization — 生产环境最佳实践
...
- **MEDIUM**: prune=true 会自动删除 Git 中不存在的集群资源
...
- [[bp-flux-create-source|flux create source]]
...
[[flux-create-kustomization|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
