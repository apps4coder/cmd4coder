...
| 安装 | Download from https://k9scli.io/topics/install/ |
...
- **LOW**: Interactive UI; risk depends on user actions
- **MEDIUM**: Can execute dangerous operations if not careful
...
**Launch in production namespace**:
```bash
k9s -n production
```
...
[[k9s|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
