---
title: "mysqlimport 生产环境最佳实践"
cmd_name: "mysqlimport"
cmd_category: "数据库工具/MySQL工具"
source_page: "[[mysqlimport]]"
domain: "database"
risk_level: "high"
...
- **HIGH**: Can overwrite or modify existing data
- **MEDIUM**: Large imports may lock tables and affect performance
- 数据库连接强制使用 TLS 加密
...
[[mysqlimport|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
