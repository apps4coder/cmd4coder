---
title: "kfctl apply 生产环境最佳实践"
cmd_name: "kfctl apply"
cmd_category: "容器编排/K8s机器学习运维"
source_page: "[[kfctl-apply]]"
domain: "container"
risk_level: "critical"
...
| 安装 | Download from https://github.com/kubeflow/kfctl/releases |
...
- **CRITICAL**: Deploys full Kubeflow stack; resource-intensive operation
- **HIGH**: Creates many namespaces and resources
...
[[kfctl-apply|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
