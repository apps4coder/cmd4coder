---
title: "kubectl get notebooks 生产环境最佳实践"
cmd_name: "kubectl get notebooks"
cmd_category: "容器编排/K8s机器学习运维"
source_page: "[[kubectl-get-notebooks]]"
domain: "container"
risk_level: "low"
...
# kubectl get notebooks — 生产环境最佳实践
...
| 安装 | Requires Kubeflow Notebooks component |
...
**List notebooks in user namespace**:
```bash
...
[[kubectl-get-notebooks|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
