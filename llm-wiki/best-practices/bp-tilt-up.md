...
| 安装 | Download from https://docs.tilt.dev/install.html |
...
- **MEDIUM**: Deploys to cluster with live updates
- **LOW**: Intended for local development
...
[[tilt-up|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
