---
title: "anything-llm 生产环境最佳实践"
cmd_name: "anything-llm"
cmd_category: "AI基础设施/扩展工具"
source_page: "[[anything-llm]]"
domain: "ai-infra"
risk_level: "medium"
platforms: ["linux", "darwin"]
tags: ["ai-infra", "risk-medium", "linux", "darwin"]
created: "2026-07-28"
source_file: "ai/llm-extra.yaml"
---

# anything-llm — 生产环境最佳实践
...
| 领域 | `ai-infra` |
| 平台 | `linux`, `darwin` |
| 安装 | 参考 https://github.com/Mintplex-Labs/anything-llm/blob/master/BARE_METAL.md |
...
- **MEDIUM**: 上传文档可能包含敏感信息，请做好访问控制和数据隔离
...
[[anything-llm|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
