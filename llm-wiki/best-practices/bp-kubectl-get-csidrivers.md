---
title: "kubectl get csidrivers 生产环境最佳实践"
cmd_name: "kubectl get csidrivers"
cmd_category: "容器编排/K8s存储增强"
source_page: "[[kubectl-get-csidrivers]]"
domain: "container"
risk_level: "low"
...
# kubectl get csidrivers — 生产环境最佳实践
...
- **LOW**: Read-only operation; shows storage drivers
...
[[kubectl-get-csidrivers|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
