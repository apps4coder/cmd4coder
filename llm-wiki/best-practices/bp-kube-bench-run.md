---
title: "kube-bench run 生产环境最佳实践"
cmd_name: "kube-bench run"
cmd_category: "容器编排/K8s安全工具"
source_page: "[[kube-bench-run]]"
domain: "container"
risk_level: "low"
platforms: ["linux"]
...
| 领域 | `container` |
| 平台 | `linux` |
| 安装 | Download from https://github.com/aquasecurity/kube-bench/releases |
...
- **LOW**: Read-only assessment; checks configuration only
...
[[kube-bench-run|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
