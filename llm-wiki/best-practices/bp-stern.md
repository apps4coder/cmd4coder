...
| 安装 | Download from https://github.com/stern/stern |
...
- **LOW**: Read-only operation; tails logs only
...
**Tail nginx pods in production namespace**:
```bash
...
[[stern|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
