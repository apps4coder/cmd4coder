...
| 安装 | 参考 https://kubernetes.io/docs/tasks/tools/ |
...
- [[bp-kubectl-get|kubectl get]]
- [[bp-kubectl-apply|kubectl apply]]
- helm
...
[[kubectl|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
