---
title: "kube-hunter 生产环境最佳实践"
cmd_name: "kube-hunter"
cmd_category: "容器编排/K8s安全扩展"
source_page: "[[kube-hunter]]"
domain: "container"
risk_level: "high"
platforms: ["linux"]
tags: ["container", "risk-high", "linux"]
created: "2026-07-28"
source_file: "container/k8s/k8s-security-extra.yaml"
---

# kube-hunter — 生产环境最佳实践
...
| 领域 | `container` |
| 平台 | `linux` |
| 安装 | pip install kube-hunter 或参考 https://github.com/aquasecurity/kube-hunter |
...
- **HIGH**: 渗透测试会产生攻击行为，请仅在授权和隔离环境中执行
- **HIGH**: 安全扫描和渗透测试会访问集群资源，请使用最小权限并仅在授权范围内执行。
...
[[kube-hunter|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
