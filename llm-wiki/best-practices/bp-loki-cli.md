---
title: "loki-cli 生产环境最佳实践"
cmd_name: "loki-cli"
cmd_category: "容器编排/云原生扩展"
source_page: "[[loki-cli]]"
domain: "container"
risk_level: "low"
...
| 领域 | `container` |
| 平台 | `linux`, `darwin` |
| 安装 | 参考 https://grafana.com/docs/loki/latest/getting-started/logcli/ |
...
- [[bp-promtail|promtail]]
- [[bp-grafana-server|grafana-server]]
...
[[loki-cli|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
