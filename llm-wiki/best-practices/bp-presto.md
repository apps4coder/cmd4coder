...
| 领域 | `general` |
| 平台 | `linux`, `darwin` |
| 安装 | 参考 https://prestodb.io/docs/current/installation.html |
...
- **MEDIUM**: 跨源查询可能扫描大量数据，请关注资源队列和成本
...
[[presto|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
