...
| 领域 | `container` |
| 平台 | `linux`, `darwin` |
| 安装 | 参考 https://docs.openshift.com/container-platform/latest/cli_reference/openshift_cli/getting-started-cli.html |
...
- **MEDIUM**: oc 拥有 cluster-admin 能力时请谨慎使用
...
[[oc|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
