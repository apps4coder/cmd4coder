---
title: "istioctl version 生产环境最佳实践"
cmd_name: "istioctl version"
cmd_category: "容器编排/K8s网络插件"
source_page: "[[istioctl-version]]"
domain: "container"
risk_level: "low"
...
| 安装 | Download from https://istio.io/latest/docs/setup/getting-started/#download |
...
**Display Istio client and control plane versions**:
```bash
istioctl version
```
...
[[istioctl-version|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
