...
created: "2026-07-28"
source_file: "hardware/network.yaml"
---
...
- **HIGH**: 可能影响服务可用性或数据完整性，生产环境请先确认参数、通知相关方并在低峰期执行。
...
[[rfkill|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
