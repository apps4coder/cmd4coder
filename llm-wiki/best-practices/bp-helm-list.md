---
title: "helm list 生产环境最佳实践"
cmd_name: "helm list"
cmd_category: "容器编排/K8s Helm包管理"
source_page: "[[helm-list]]"
domain: "container"
risk_level: "low"
...
- **LOW**: Read-only operation; lists releases only
...
**List releases in production namespace**:
```bash
...
[[helm-list|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
