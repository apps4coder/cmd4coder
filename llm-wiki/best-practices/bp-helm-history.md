---
title: "helm history 生产环境最佳实践"
cmd_name: "helm history"
cmd_category: "容器编排/K8s Helm包管理"
source_page: "[[helm-history]]"
domain: "container"
risk_level: "low"
...
- **LOW**: Read-only operation; shows revision history
...
**View history in production namespace**:
```bash
...
[[helm-history|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
