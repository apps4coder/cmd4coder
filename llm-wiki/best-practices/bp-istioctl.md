---
title: "istioctl 生产环境最佳实践"
cmd_name: "istioctl"
cmd_category: "网络工具/服务网格"
source_page: "[[istioctl]]"
domain: "network"
risk_level: "high"
platforms: ["linux", "darwin"]
tags: ["network", "risk-high", "linux", "darwin"]
created: "2026-07-28"
...
| 领域 | `network` |
| 平台 | `linux`, `darwin` |
| 安装 | curl -L https://istio.io/downloadIstio | sh - (或 brew install istioctl) |
...
- **HIGH**: install/upgrade/uninstall 影响整个网格基础设施
...
- [[bp-kubectl|kubectl]]
- [[bp-istioctl-analyze|istioctl analyze]]
...
[[istioctl|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
