---
title: "kubectl get servicemonitors 生产环境最佳实践"
cmd_name: "kubectl get servicemonitors"
cmd_category: "容器编排/K8s监控日志"
source_page: "[[kubectl-get-servicemonitors]]"
domain: "container"
risk_level: "low"
...
# kubectl get servicemonitors — 生产环境最佳实践
...
| 安装 | kubectl with Prometheus Operator CRDs |
...
- **LOW**: Read-only operation; shows monitoring targets
...
**List ServiceMonitors in monitoring namespace**:
```bash
...
[[kubectl-get-servicemonitors|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
