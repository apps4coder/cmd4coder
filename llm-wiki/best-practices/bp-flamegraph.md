---
title: "flamegraph 生产环境最佳实践"
cmd_name: "flamegraph"
cmd_category: "诊断工具/性能分析"
source_page: "[[flamegraph]]"
...
| 领域 | `observability` |
| 平台 | `linux`, `darwin` |
| 安装 | git clone https://github.com/brendangregg/FlameGraph 或 brew install flamegraph (macOS) |
...
[[flamegraph|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
