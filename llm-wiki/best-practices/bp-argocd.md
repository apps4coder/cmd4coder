...
| 领域 | `cicd` |
| 平台 | `linux`, `darwin` |
| 安装 | brew install argocd (macOS) 或 curl -sSL -o argocd https://github.com/argoproj/argo-cd/releases/latest/download/argocd-linux-amd64 |
...
[[argocd|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
