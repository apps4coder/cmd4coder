---
title: "ansible-galaxy install 生产环境最佳实践"
cmd_name: "ansible-galaxy install"
cmd_category: "容器编排/K8s配置管理"
source_page: "[[ansible-galaxy-install]]"
domain: "container"
risk_level: "low"
...
# ansible-galaxy install — 生产环境最佳实践
...
- **LOW**: Downloads roles; no system changes
...
[[ansible-galaxy-install|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
