---
title: "helm status 生产环境最佳实践"
cmd_name: "helm status"
cmd_category: "容器编排/K8s Helm包管理"
source_page: "[[helm-status]]"
domain: "container"
risk_level: "low"
...
- **LOW**: Read-only operation; displays status only
...
**Show status of release in production**:
```bash
...
[[helm-status|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
