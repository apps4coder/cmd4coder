...
- **HIGH**: Load testing may overwhelm target server
- **HIGH**: 对非自有系统进行压力测试可能违反安全策略，务必获得书面授权。
...
**Test with 25 users for 1 minute**:
```bash
...
[[siege|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
