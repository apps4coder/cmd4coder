---
title: "istioctl experimental 生产环境最佳实践"
cmd_name: "istioctl experimental"
cmd_category: "网络工具/服务网格"
source_page: "[[istioctl-experimental]]"
domain: "network"
risk_level: "medium"
...
# istioctl experimental — 生产环境最佳实践
...
| 领域 | `network` |
| 平台 | `linux`, `darwin` |
| 安装 | curl -L https://istio.io/downloadIstio | sh - |
...
[[istioctl-experimental|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
