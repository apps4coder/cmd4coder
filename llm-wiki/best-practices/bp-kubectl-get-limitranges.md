---
title: "kubectl get limitranges 生产环境最佳实践"
cmd_name: "kubectl get limitranges"
cmd_category: "容器编排/K8s安全工具"
source_page: "[[kubectl-get-limitranges]]"
domain: "container"
risk_level: "low"
...
# kubectl get limitranges — 生产环境最佳实践
...
- **LOW**: Read-only operation; shows resource constraints
...
**List resource limits in production namespace**:
```bash
...
[[kubectl-get-limitranges|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
