---
title: "kubectl get scrapeconfigs 生产环境最佳实践"
cmd_name: "kubectl get scrapeconfigs"
cmd_category: "容器编排/K8s监控日志"
source_page: "[[kubectl-get-scrapeconfigs]]"
domain: "container"
risk_level: "low"
...
# kubectl get scrapeconfigs — 生产环境最佳实践
...
| 安装 | kubectl with Prometheus Operator v0.65+ |
...
- **LOW**: Read-only operation; shows external monitoring targets
...
**List scrape configurations in monitoring namespace**:
```bash
...
[[kubectl-get-scrapeconfigs|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
