---
title: "systemctl status kube-state-metrics 生产环境最佳实践"
cmd_name: "systemctl status kube-state-metrics"
cmd_category: "容器编排/K8s监控日志"
source_page: "[[systemctl-status-kube-state-metrics]]"
domain: "container"
risk_level: "low"
platforms: ["linux"]
tags: ["container", "risk-low", "linux"]
created: "2026-07-28"
source_file: "container/k8s/k8s-monitor.yaml"
---

# systemctl status kube-state-metrics — 生产环境最佳实践
...
| 领域 | `container` |
| 平台 | `linux` |
| 安装 | Usually deployed as Kubernetes deployment |
...
- **LOW**: Read-only status check; no risks
- **LOW**: Restarting causes brief metrics gap
...
**View kube-state-metrics status**:
```bash
...
[[systemctl-status-kube-state-metrics|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
