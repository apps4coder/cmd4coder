---
title: "cilium hubble status 生产环境最佳实践"
cmd_name: "cilium hubble status"
cmd_category: "容器编排/K8s网络插件"
source_page: "[[cilium-hubble-status]]"
domain: "container"
risk_level: "low"
platforms: ["linux"]
...
| 领域 | `container` |
| 平台 | `linux` |
| 安装 | Installed with Cilium Hubble |
...
- **LOW**: Read-only observation; no operational impact
...
[[cilium-hubble-status|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
