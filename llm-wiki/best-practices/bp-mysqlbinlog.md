---
title: "mysqlbinlog 生产环境最佳实践"
cmd_name: "mysqlbinlog"
cmd_category: "数据库工具/MySQL工具"
source_page: "[[mysqlbinlog]]"
domain: "database"
risk_level: "high"
...
- **HIGH**: Replaying binary logs can modify database; use with caution
- **MEDIUM**: Binary logs may contain sensitive data
- 数据库连接强制使用 TLS 加密
...
[[mysqlbinlog|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
