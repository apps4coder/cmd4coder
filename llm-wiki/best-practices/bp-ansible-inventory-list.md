---
title: "ansible-inventory --list 生产环境最佳实践"
cmd_name: "ansible-inventory --list"
cmd_category: "容器编排/K8s配置管理"
source_page: "[[ansible-inventory-list]]"
domain: "container"
risk_level: "low"
...
# ansible-inventory --list — 生产环境最佳实践
...
- **LOW**: Read-only inventory display
...
[[ansible-inventory-list|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
