---
title: "kubectl port-forward svc/prometheus-operated 生产环境最佳实践"
cmd_name: "kubectl port-forward svc/prometheus-operated"
cmd_category: "容器编排/K8s监控日志"
source_page: "[[kubectl-port-forward-svc-prometheus-operated]]"
domain: "container"
risk_level: "medium"
...
# kubectl port-forward svc/prometheus-operated — 生产环境最佳实践
...
- **MEDIUM**: Exposes monitoring interface; may contain sensitive metrics
...
**Access Prometheus UI locally on port 9090**:
```bash
...
[[kubectl-port-forward-svc-prometheus-operated|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
