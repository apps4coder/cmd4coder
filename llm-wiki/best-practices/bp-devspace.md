---
title: "devspace 生产环境最佳实践"
cmd_name: "devspace"
cmd_category: "容器编排/云原生扩展二"
source_page: "[[devspace]]"
domain: "container"
risk_level: "medium"
...
| 领域 | `container` |
| 平台 | `linux`, `darwin` |
| 安装 | 参考 https://www.devspace.sh/docs/getting-started/install |
...
- **MEDIUM**: devspace deploy 会修改集群，请确认 namespace 和 values
...
[[devspace|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
