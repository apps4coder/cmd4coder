---
title: "kubectl get thanosrulers 生产环境最佳实践"
cmd_name: "kubectl get thanosrulers"
cmd_category: "容器编排/K8s监控日志"
source_page: "[[kubectl-get-thanosrulers]]"
domain: "container"
risk_level: "low"
...
# kubectl get thanosrulers — 生产环境最佳实践
...
| 安装 | kubectl with Thanos Operator CRDs |
...
- **LOW**: Read-only operation; requires Thanos deployment
...
**List Thanos rulers in monitoring namespace**:
```bash
...
[[kubectl-get-thanosrulers|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
