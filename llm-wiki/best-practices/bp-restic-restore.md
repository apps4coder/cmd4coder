---
title: "restic restore 生产环境最佳实践"
cmd_name: "restic restore"
cmd_category: "容器编排/K8s备份恢复"
source_page: "[[restic-restore]]"
domain: "container"
risk_level: "high"
...
| 安装 | Download from https://restic.net/ or package manager |
...
- **HIGH**: Overwrites files in target directory
- **MEDIUM**: Verify snapshot before restoring
...
[[restic-restore|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
