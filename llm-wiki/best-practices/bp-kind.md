...
| 安装 | 参考 https://kind.sigs.k8s.io/docs/user/quick-start/#installation |
...
- **MEDIUM**: 创建多个集群会占用较多内存和 CPU，请确认本机资源
...
[[kind|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
