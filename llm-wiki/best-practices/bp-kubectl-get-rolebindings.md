---
title: "kubectl get rolebindings 生产环境最佳实践"
cmd_name: "kubectl get rolebindings"
cmd_category: "容器编排/K8s安全工具"
source_page: "[[kubectl-get-rolebindings]]"
domain: "container"
risk_level: "low"
...
# kubectl get rolebindings — 生产环境最佳实践
...
- **LOW**: Read-only operation; shows access assignments
...
**List role bindings in production namespace**:
```bash
...
[[kubectl-get-rolebindings|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
