---
title: "kubectl get ingress 生产环境最佳实践"
cmd_name: "kubectl get ingress"
cmd_category: "容器编排/K8s网络插件"
source_page: "[[kubectl-get-ingress]]"
domain: "container"
risk_level: "low"
...
**List ingresses in production namespace**:
```bash
...
[[kubectl-get-ingress|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
