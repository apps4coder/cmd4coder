---
title: "containerd 生产环境最佳实践"
cmd_name: "containerd"
cmd_category: "容器编排/云原生扩展二"
source_page: "[[containerd]]"
domain: "container"
risk_level: "medium"
...
| 领域 | `container` |
| 平台 | `linux`, `darwin` |
| 安装 | 参考 https://github.com/containerd/containerd/blob/main/docs/getting-started.md |
...
- **MEDIUM**: containerd 是底层运行时，配置错误会导致容器无法启动
...
[[containerd|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
