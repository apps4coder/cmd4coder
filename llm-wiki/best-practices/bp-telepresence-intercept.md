---
title: "telepresence intercept 生产环境最佳实践"
cmd_name: "telepresence intercept"
cmd_category: "容器编排/K8s开发调试"
source_page: "[[telepresence-intercept]]"
domain: "container"
risk_level: "critical"
platforms: ["linux", "darwin", "windows"]
tags: ["container", "risk-critical", "linux", "darwin", "windows"]
created: "2026-07-28"
source_file: "container/k8s/k8s-dev.yaml"
---

# telepresence intercept — 生产环境最佳实践
...
| 安装 | Download from https://www.telepresence.io/docs/latest/install/ |
...
- **CRITICAL**: Redirects production traffic to local machine
- **HIGH**: Can cause service disruption if local process fails
...
**Intercept production service to local dev**:
```bash
...
[[telepresence-intercept|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
