---
title: "promtool check config 生产环境最佳实践"
cmd_name: "promtool check config"
cmd_category: "容器编排/K8s监控日志"
source_page: "[[promtool-check-config]]"
domain: "container"
risk_level: "low"
...
# promtool check config — 生产环境最佳实践
...
| 安装 | Installed with Prometheus or download from https://prometheus.io/download/ |
...
- **LOW**: Read-only validation; no operational impact
...
[[promtool-check-config|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
