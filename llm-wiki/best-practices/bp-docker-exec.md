---
title: "docker exec 生产环境最佳实践"
cmd_name: "docker exec"
cmd_category: "容器编排/Docker命令"
source_page: "[[docker-exec]]"
domain: "container"
risk_level: "medium"
platforms: ["linux", "darwin", "windows"]
tags: ["container", "risk-medium", "linux", "darwin", "windows"]
created: "2026-07-28"
source_file: "container/docker/docker.yaml"
---

# docker exec — 生产环境最佳实践
...
- 后台容器务必配置日志轮转：`--log-opt max-size=10m --log-opt max-file=5`

## 安全加固

- **MEDIUM**: 会改变容器生命周期或构建新镜像，请在测试环境验证参数后再用于生产。
...
- [[bp-docker-attach|docker attach]]
- [[bp-docker-run|docker run]]
...
[[docker-exec|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
