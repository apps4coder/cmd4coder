---
title: "open-webui 生产环境最佳实践"
cmd_name: "open-webui"
cmd_category: "AI基础设施/扩展工具"
source_page: "[[open-webui]]"
domain: "ai-infra"
risk_level: "medium"
...
| 领域 | `ai-infra` |
| 平台 | `linux`, `darwin` |
| 安装 | pip install open-webui 或 Docker 运行 |
...
- **MEDIUM**: WebUI 会暴露模型接口，请配置认证和网络访问控制
...
[[open-webui|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
