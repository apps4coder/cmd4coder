---
title: "kafka-producer-perf-test 生产环境最佳实践"
cmd_name: "kafka-producer-perf-test"
cmd_category: "大数据/扩展工具"
source_page: "[[kafka-producer-perf-test]]"
domain: "general"
risk_level: "high"
...
# kafka-producer-perf-test — 生产环境最佳实践
...
- **HIGH**: 压测会写入大量数据到 Kafka，请确认 topic 配置和磁盘空间
...
- [[bp-kafka-consumer-perf-test|kafka-consumer-perf-test]]
...
[[kafka-producer-perf-test|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
