---
title: "proxychains 生产环境最佳实践"
cmd_name: "proxychains"
cmd_category: "网络工具/扩展工具"
source_page: "[[proxychains]]"
domain: "network"
risk_level: "medium"
...
| 领域 | `network` |
| 平台 | `linux`, `darwin` |
| 安装 | 包管理器安装，如 sudo apt install proxychains4 |
...
- **MEDIUM**: 代理配置错误会导致流量绕行或泄露，请确认代理安全
...
[[proxychains|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
