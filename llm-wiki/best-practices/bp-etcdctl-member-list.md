---
title: "etcdctl member list 生产环境最佳实践"
cmd_name: "etcdctl member list"
cmd_category: "容器编排/K8s集群管理"
source_page: "[[etcdctl-member-list]]"
domain: "container"
risk_level: "low"
platforms: ["linux"]
...
- **LOW**: Read-only operation; lists members only
...
**List cluster members in simple format**:
```bash
etcdctl member list
```
...
[[etcdctl-member-list|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
