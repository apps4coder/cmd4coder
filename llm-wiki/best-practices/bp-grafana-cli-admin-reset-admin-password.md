---
title: "grafana-cli admin reset-admin-password 生产环境最佳实践"
cmd_name: "grafana-cli admin reset-admin-password"
cmd_category: "容器编排/K8s监控日志"
source_page: "[[grafana-cli-admin-reset-admin-password]]"
domain: "container"
risk_level: "high"
...
# grafana-cli admin reset-admin-password — 生产环境最佳实践
...
- **HIGH**: Resets admin password; security-sensitive operation
- **HIGH**: 修改管理员凭据可能导致当前会话失效，建议提前通知团队成员。
...
[[grafana-cli-admin-reset-admin-password|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
