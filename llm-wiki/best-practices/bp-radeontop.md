---
title: "radeontop 生产环境最佳实践"
cmd_name: "radeontop"
cmd_category: "硬件/GPU与加速器"
source_page: "[[radeontop]]"
domain: "general"
risk_level: "low"
...
| 领域 | `general` |
| 平台 | `linux`, `darwin` |
| 安装 | 包管理器安装，如 sudo apt install radeontop |
...
- [[bp-rocm-smi|rocm-smi]]
- [[bp-intel-gpu-top|intel-gpu-top]]
...
[[radeontop|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
