---
title: "kafka-configs.sh 生产环境最佳实践"
cmd_name: "kafka-configs.sh"
cmd_category: "大数据/扩展工具"
source_page: "[[kafka-configs-sh]]"
domain: "general"
risk_level: "high"
...
- **HIGH**: 修改 topic/broker 配置会影响性能和数据保留策略，请评估影响
...
[[kafka-configs-sh|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
