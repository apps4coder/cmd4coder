---
title: "trivy k8s 生产环境最佳实践"
cmd_name: "trivy k8s"
cmd_category: "容器编排/K8s安全工具"
source_page: "[[trivy-k8s]]"
domain: "container"
risk_level: "low"
...
| 安装 | Download from https://aquasecurity.github.io/trivy/ |
...
- **LOW**: Read-only scanning; queries cluster via kubectl
...
[[trivy-k8s|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
