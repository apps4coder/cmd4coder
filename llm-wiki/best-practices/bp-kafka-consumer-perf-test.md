---
title: "kafka-consumer-perf-test 生产环境最佳实践"
cmd_name: "kafka-consumer-perf-test"
cmd_category: "大数据/扩展工具"
source_page: "[[kafka-consumer-perf-test]]"
domain: "general"
risk_level: "medium"
platforms: ["linux", "darwin"]
tags: ["general", "risk-medium", "linux", "darwin"]
created: "2026-07-28"
source_file: "bigdata/extra.yaml"
---

# kafka-consumer-perf-test — 生产环境最佳实践
...
- **MEDIUM**: 消费压测可能影响同一 consumer group 的正式消费者
...
- [[bp-kafka-producer-perf-test|kafka-producer-perf-test]]
- [[bp-kafka-consumer-groups-sh|kafka-consumer-groups.sh]]
...
[[kafka-consumer-perf-test|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
