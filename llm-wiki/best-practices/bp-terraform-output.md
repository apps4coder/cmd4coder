---
title: "terraform output 生产环境最佳实践"
cmd_name: "terraform output"
cmd_category: "容器编排/K8s配置管理"
source_page: "[[terraform-output]]"
domain: "container"
risk_level: "low"
...
- **LOW**: Read-only operation; displays values only
- **LOW**: May contain sensitive data like passwords
...
[[terraform-output|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
