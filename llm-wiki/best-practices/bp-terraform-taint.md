---
title: "terraform taint 生产环境最佳实践"
cmd_name: "terraform taint"
cmd_category: "容器编排/K8s配置管理"
source_page: "[[terraform-taint]]"
domain: "container"
risk_level: "high"
...
- **MEDIUM**: Forces resource recreation on next apply
- **HIGH**: May cause service disruption
...
**Taint deployment for recreation**:
```bash
...
[[terraform-taint|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
