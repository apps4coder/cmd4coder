---
title: "redis-cli FLUSHDB 生产环境最佳实践"
cmd_name: "redis-cli FLUSHDB"
cmd_category: "数据库工具/Redis工具"
source_page: "[[redis-cli-flushdb]]"
domain: "database"
risk_level: "critical"
...
- **CRITICAL**: Permanently deletes all data; cannot be undone
- **HIGH**: FLUSHALL affects all databases on the server
- 数据库连接强制使用 TLS 加密
...
[[redis-cli-flushdb|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
