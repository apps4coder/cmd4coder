---
title: "databricks 生产环境最佳实践"
cmd_name: "databricks"
cmd_category: "数据库工具/扩展命令"
source_page: "[[databricks]]"
domain: "database"
risk_level: "medium"
...
- **MEDIUM**: databricks 操作会产生云费用并影响作业，请确认参数
- 数据库连接强制使用 TLS 加密
...
[[databricks|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
