---
title: "kubectl delete pvc 生产环境最佳实践"
cmd_name: "kubectl delete pvc"
cmd_category: "容器编排/K8s存储增强"
source_page: "[[kubectl-delete-pvc]]"
domain: "container"
risk_level: "critical"
...
- **CRITICAL**: Deletes persistent data permanently
- **HIGH**: Always backup data before deletion
...
[[kubectl-delete-pvc|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
