---
title: "kubectl top pvc 生产环境最佳实践"
cmd_name: "kubectl top pvc"
cmd_category: "容器编排/K8s存储增强"
source_page: "[[kubectl-top-pvc]]"
domain: "container"
risk_level: "low"
...
| 安装 | kubectl with metrics-server and storage metrics |
...
**Show PVC usage in production namespace**:
```bash
...
[[kubectl-top-pvc|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
