---
title: "kafka-topics.sh 生产环境最佳实践"
cmd_name: "kafka-topics.sh"
cmd_category: "大数据/Kafka工具"
source_page: "[[kafka-topics-sh]]"
domain: "general"
risk_level: "medium"
...
- **MEDIUM**: 删除 Topic 会丢失数据，请确认 retention 和备份策略
...
[[kafka-topics-sh|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
