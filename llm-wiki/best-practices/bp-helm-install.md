---
title: "helm install 生产环境最佳实践"
cmd_name: "helm install"
cmd_category: "容器编排/K8s Helm包管理"
source_page: "[[helm-install]]"
domain: "container"
risk_level: "high"
...
- **HIGH**: Deploys resources to cluster; may affect existing workloads
- **MEDIUM**: Always review chart values before installation
...
[[helm-install|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
