---
title: "terraform state show 生产环境最佳实践"
cmd_name: "terraform state show"
cmd_category: "容器编排/K8s配置管理"
source_page: "[[terraform-state-show]]"
domain: "container"
risk_level: "low"
...
- **LOW**: Read-only; displays resource details
...
**Show deployment resource state**:
```bash
...
[[terraform-state-show|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
