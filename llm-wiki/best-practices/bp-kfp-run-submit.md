---
title: "kfp run submit 生产环境最佳实践"
cmd_name: "kfp run submit"
cmd_category: "容器编排/K8s机器学习运维"
source_page: "[[kfp-run-submit]]"
domain: "container"
risk_level: "medium"
...
- **MEDIUM**: Creates pipeline run; consumes cluster resources
...
[[kfp-run-submit|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
