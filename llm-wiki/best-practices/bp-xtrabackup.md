---
title: "xtrabackup 生产环境最佳实践"
cmd_name: "xtrabackup"
cmd_category: "数据库工具/扩展命令"
source_page: "[[xtrabackup]]"
domain: "database"
risk_level: "medium"
...
| 领域 | `database` |
| 平台 | `linux`, `darwin` |
| 安装 | 参考 https://docs.percona.com/percona-xtrabackup |
...
- **MEDIUM**: prepare 会修改备份文件，请保留原始备份副本
- 数据库连接强制使用 TLS 加密
...
[[xtrabackup|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
