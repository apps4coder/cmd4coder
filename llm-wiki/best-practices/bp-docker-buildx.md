---
title: "docker buildx 生产环境最佳实践"
cmd_name: "docker buildx"
cmd_category: "容器编排/云原生扩展"
source_page: "[[docker-buildx]]"
domain: "container"
risk_level: "medium"
...
| 领域 | `container` |
| 平台 | `linux`, `darwin` |
| 安装 | Docker Desktop 自带或 docker-buildx 插件 |
...
- [[bp-docker-build|docker build]]
- [[bp-buildkit|buildkit]]
...
[[docker-buildx|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
