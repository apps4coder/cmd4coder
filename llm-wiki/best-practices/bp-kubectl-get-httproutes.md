---
title: "kubectl get httproutes 生产环境最佳实践"
cmd_name: "kubectl get httproutes"
cmd_category: "容器编排/K8s网络插件"
source_page: "[[kubectl-get-httproutes]]"
domain: "container"
risk_level: "low"
...
# kubectl get httproutes — 生产环境最佳实践
...
| 安装 | kubectl with Gateway API CRDs installed |
...
- **LOW**: Read-only operation; shows routing rules
...
**List HTTP routes in production namespace**:
```bash
...
[[kubectl-get-httproutes|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
