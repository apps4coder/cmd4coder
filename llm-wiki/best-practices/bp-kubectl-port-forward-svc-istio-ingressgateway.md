---
title: "kubectl port-forward svc/istio-ingressgateway 生产环境最佳实践"
cmd_name: "kubectl port-forward svc/istio-ingressgateway"
cmd_category: "容器编排/K8s机器学习运维"
source_page: "[[kubectl-port-forward-svc-istio-ingressgateway]]"
domain: "container"
risk_level: "low"
...
# kubectl port-forward svc/istio-ingressgateway — 生产环境最佳实践
...
| 安装 | Requires Kubeflow with Istio deployed |
...
- **LOW**: Local port forwarding only
...
**Forward Kubeflow dashboard to localhost:8080**:
```bash
...
[[kubectl-port-forward-svc-istio-ingressgateway|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
