---
title: "aws cloudformation 生产环境最佳实践"
cmd_name: "aws cloudformation"
cmd_category: "云平台/AWS CLI"
source_page: "[[aws-cloudformation]]"
domain: "cloud"
risk_level: "high"
...
- **HIGH**: delete-stack 会删除所有关联资源，操作不可逆
- **HIGH**: 云资源操作可能产生费用或删除数据，建议先确认区域、账号，并使用 --dry-run 验证。
...
[[aws-cloudformation|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
