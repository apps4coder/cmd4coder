---
title: "helm lint 生产环境最佳实践"
cmd_name: "helm lint"
cmd_category: "容器编排/K8s Helm包管理"
source_page: "[[helm-lint]]"
domain: "container"
risk_level: "low"
...
- **LOW**: Static analysis only; validates chart structure
...
**Lint chart in mychart directory**:
```bash
helm lint mychart
```
...
[[helm-lint|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
