...
| 领域 | `cicd` |
| 平台 | `linux`, `darwin` |
| 安装 | brew install dagger/tap/dagger (macOS) 或 curl -L https://dl.dagger.io/dagger/install.sh | sh |
...
[[dagger|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
