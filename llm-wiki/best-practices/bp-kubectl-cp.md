---
title: "kubectl cp 生产环境最佳实践"
cmd_name: "kubectl cp"
cmd_category: "容器编排/K8s存储增强"
source_page: "[[kubectl-cp]]"
domain: "container"
risk_level: "high"
...
- **MEDIUM**: Transfers data between environments
- **HIGH**: Large transfers may impact network performance
...
[[kubectl-cp|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
