---
title: "kubectl drain 生产环境最佳实践"
cmd_name: "kubectl drain"
cmd_category: "容器编排/Kubernetes命令"
source_page: "[[kubectl-drain]]"
domain: "container"
risk_level: "critical"
...
- **CRITICAL**: Evicts all pods from node; can cause service disruption if not properly planned
- **HIGH**: May delete data from emptyDir volumes permanently
...
[[kubectl-drain|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
