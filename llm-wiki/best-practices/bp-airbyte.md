...
| 领域 | `general` |
| 平台 | `linux`, `darwin` |
| 安装 | 参考 https://docs.airbyte.com/using-airbyte/getting-started/oss-quickstart |
...
- **MEDIUM**: 连接源和目标会涉及凭据，请使用 Secret 管理
...
[[airbyte|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
