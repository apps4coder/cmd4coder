---
title: "redis-check-aof 生产环境最佳实践"
cmd_name: "redis-check-aof"
cmd_category: "数据库工具/Redis工具"
source_page: "[[redis-check-aof]]"
domain: "database"
risk_level: "high"
...
- **HIGH**: Fixing may truncate corrupted data; backup file first
- **MEDIUM**: Always stop Redis server before checking AOF
- 数据库连接强制使用 TLS 加密
...
[[redis-check-aof|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
