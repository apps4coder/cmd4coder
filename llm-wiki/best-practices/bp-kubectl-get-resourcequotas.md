---
title: "kubectl get resourcequotas 生产环境最佳实践"
cmd_name: "kubectl get resourcequotas"
cmd_category: "容器编排/K8s安全工具"
source_page: "[[kubectl-get-resourcequotas]]"
domain: "container"
risk_level: "low"
...
# kubectl get resourcequotas — 生产环境最佳实践
...
- **LOW**: Read-only operation; shows resource allocations
...
**List quotas in production namespace**:
```bash
...
[[kubectl-get-resourcequotas|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
