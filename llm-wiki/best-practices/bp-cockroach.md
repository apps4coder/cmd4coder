---
title: "cockroach 生产环境最佳实践"
cmd_name: "cockroach"
cmd_category: "数据库工具/扩展工具"
source_page: "[[cockroach]]"
domain: "database"
risk_level: "high"
platforms: ["linux", "darwin"]
tags: ["database", "risk-high", "linux", "darwin"]
created: "2026-07-28"
source_file: "database/extra.yaml"
---
...
| 领域 | `database` |
| 平台 | `linux`, `darwin` |
| 安装 | 参考 https://www.cockroachlabs.com/docs/stable/install-cockroachdb-linux |
...
- **HIGH**: init 和节点管理操作会影响整个集群，请在测试环境验证
...
[[cockroach|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
