---
title: "restic backup 生产环境最佳实践"
cmd_name: "restic backup"
cmd_category: "容器编排/K8s备份恢复"
source_page: "[[restic-backup]]"
domain: "container"
risk_level: "low"
...
- **LOW**: Read-only backup operation; no data modification
...
**Backup directory to repository**:
```bash
...
[[restic-backup|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
