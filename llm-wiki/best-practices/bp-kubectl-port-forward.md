---
title: "kubectl port-forward 生产环境最佳实践"
cmd_name: "kubectl port-forward"
cmd_category: "容器编排/Kubernetes命令"
source_page: "[[kubectl-port-forward]]"
domain: "container"
risk_level: "medium"
...
- **MEDIUM**: Exposes pod ports to local machine; ensure proper security
...
[[kubectl-port-forward|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
