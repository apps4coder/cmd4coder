---
title: "go generate 生产环境最佳实践"
cmd_name: "go generate"
cmd_category: "编程语言/Go工具链扩展"
source_page: "[[go-generate]]"
domain: "devtool"
risk_level: "medium"
...
- **MEDIUM**: 执行任意命令（由 //go:generate 定义），审查生成指令
...
[[go-generate|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
