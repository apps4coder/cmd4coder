...
| 安装 | 包管理器安装，如 sudo apt install iperf3 / sudo yum install iperf3 |
...
- **MEDIUM**: 带宽测试会占满链路，可能影响其他业务流量，请选择合适的时间窗口
...
[[iperf3|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
