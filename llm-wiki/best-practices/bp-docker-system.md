---
title: "docker system 生产环境最佳实践"
cmd_name: "docker system"
cmd_category: "容器编排/云原生扩展"
source_page: "[[docker-system]]"
domain: "container"
risk_level: "high"
...
- **HIGH**: prune 会删除未使用的镜像、容器、网络和卷，请确认后再执行
...
[[docker-system|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
