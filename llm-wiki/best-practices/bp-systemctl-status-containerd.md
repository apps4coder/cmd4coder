---
title: "systemctl status containerd 生产环境最佳实践"
cmd_name: "systemctl status containerd"
cmd_category: "容器编排/K8s容器运行时"
source_page: "[[systemctl-status-containerd]]"
domain: "container"
risk_level: "high"
platforms: ["linux"]
...
# systemctl status containerd — 生产环境最佳实践
...
- **HIGH**: Restarting containerd affects all running containers
...
[[systemctl-status-containerd|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
