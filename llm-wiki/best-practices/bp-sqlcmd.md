...
| 领域 | `database` |
| 平台 | `linux`, `darwin` |
| 安装 | 参考 https://docs.microsoft.com/sql/tools/sqlcmd-utility |
...
- **MEDIUM**: sqlcmd 可直接执行 DDL/DML，生产环境请确认脚本内容
- 数据库连接强制使用 TLS 加密
...
[[sqlcmd|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
