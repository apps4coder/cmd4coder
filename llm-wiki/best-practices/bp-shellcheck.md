---
title: "shellcheck 生产环境最佳实践"
cmd_name: "shellcheck"
cmd_category: "Shell脚本/Bash工具"
source_page: "[[shellcheck]]"
domain: "shell"
risk_level: "low"
...
| 领域 | `shell` |
| 平台 | `linux`, `darwin` |
| 安装 | apt install shellcheck (Ubuntu) 或 brew install shellcheck (macOS) |
...
[[shellcheck|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
