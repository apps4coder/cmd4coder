...
created: "2026-07-28"
source_file: "container/k8s/k8s-utilities.yaml"
---
...
| 安装 | Download from https://github.com/ahmetb/kubectx |
...
- **HIGH**: Switching contexts changes target cluster; verify before executing commands
- **MEDIUM**: Accidental switch to production can cause issues
...
[[kubectx|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
