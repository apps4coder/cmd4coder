---
title: "istioctl proxy-status 生产环境最佳实践"
cmd_name: "istioctl proxy-status"
cmd_category: "容器编排/K8s网络插件"
source_page: "[[istioctl-proxy-status]]"
domain: "container"
risk_level: "low"
...
# istioctl proxy-status — 生产环境最佳实践
...
| 安装 | Istio service mesh installation |
...
- **LOW**: Read-only status check; shows proxy health
...
**Check proxies in production namespace**:
```bash
...
[[istioctl-proxy-status|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
