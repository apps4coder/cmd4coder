---
title: "systemctl status promtail 生产环境最佳实践"
cmd_name: "systemctl status promtail"
cmd_category: "容器编排/K8s监控日志"
source_page: "[[systemctl-status-promtail]]"
domain: "container"
risk_level: "medium"
platforms: ["linux"]
...
# systemctl status promtail — 生产环境最佳实践
...
- **MEDIUM**: Restarting Promtail causes log collection gap
...
[[systemctl-status-promtail|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
