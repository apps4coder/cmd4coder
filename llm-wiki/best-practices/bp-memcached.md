---
title: "memcached 生产环境最佳实践"
cmd_name: "memcached"
cmd_category: "数据库工具/扩展命令"
source_page: "[[memcached]]"
domain: "database"
risk_level: "medium"
...
| 领域 | `database` |
| 平台 | `linux`, `darwin` |
| 安装 | 包管理器安装，如 sudo apt install memcached |
...
- **MEDIUM**: 默认无认证，请勿直接暴露到公网，建议使用 SASL 或防火墙
- 数据库连接强制使用 TLS 加密
...
[[memcached|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
