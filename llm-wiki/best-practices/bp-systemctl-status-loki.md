---
title: "systemctl status loki 生产环境最佳实践"
cmd_name: "systemctl status loki"
cmd_category: "容器编排/K8s监控日志"
source_page: "[[systemctl-status-loki]]"
domain: "container"
risk_level: "medium"
platforms: ["linux"]
...
# systemctl status loki — 生产环境最佳实践
...
- **MEDIUM**: Restarting Loki causes log ingestion interruption
...
[[systemctl-status-loki|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
