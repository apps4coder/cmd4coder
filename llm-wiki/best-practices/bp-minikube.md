---
title: "minikube 生产环境最佳实践"
cmd_name: "minikube"
cmd_category: "容器编排/本地K8s"
source_page: "[[minikube]]"
domain: "container"
risk_level: "medium"
...
| 安装 | 参考 https://minikube.sigs.k8s.io/docs/start/ |
...
- **MEDIUM**: minikube 会创建虚拟机/容器，请确保有足够磁盘和内存
...
[[minikube|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
