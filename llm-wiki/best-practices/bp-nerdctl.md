...
| 领域 | `container` |
| 平台 | `linux` |
| 安装 | 参考 https://github.com/containerd/nerdctl/blob/main/docs/install.md |
...
- **MEDIUM**: nerdctl 直接操作 containerd，可能影响 Kubernetes 使用的容器
...
[[nerdctl|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
