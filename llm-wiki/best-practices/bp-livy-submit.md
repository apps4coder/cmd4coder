---
title: "livy-submit 生产环境最佳实践"
cmd_name: "livy-submit"
cmd_category: "大数据/扩展工具"
source_page: "[[livy-submit]]"
domain: "general"
risk_level: "medium"
...
| 领域 | `general` |
| 平台 | `linux`, `darwin` |
| 安装 | 参考 https://livy.apache.org/get-started/ |
...
- **MEDIUM**: REST 提交时请保护 Livy 服务端点，避免未授权访问
...
[[livy-submit|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
