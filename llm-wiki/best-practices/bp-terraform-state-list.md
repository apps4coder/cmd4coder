---
title: "terraform state list 生产环境最佳实践"
cmd_name: "terraform state list"
cmd_category: "容器编排/K8s配置管理"
source_page: "[[terraform-state-list]]"
domain: "container"
risk_level: "low"
...
- **LOW**: Read-only operation; lists state resources
...
[[terraform-state-list|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
