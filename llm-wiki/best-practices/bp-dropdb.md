...
- **CRITICAL**: Permanently deletes database; cannot be undone
- **HIGH**: Always backup before dropping database
- 数据库连接强制使用 TLS 加密
...
[[dropdb|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
