---
title: "ansible-playbook 生产环境最佳实践"
cmd_name: "ansible-playbook"
cmd_category: "容器编排/K8s配置管理"
source_page: "[[ansible-playbook]]"
domain: "container"
risk_level: "high"
...
- **HIGH**: Executes configuration changes on target hosts
- **MEDIUM**: Always test in staging environment first
...
[[ansible-playbook|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
