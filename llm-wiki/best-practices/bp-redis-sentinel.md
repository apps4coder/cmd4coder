---
title: "redis-sentinel 生产环境最佳实践"
cmd_name: "redis-sentinel"
cmd_category: "数据库工具/Redis工具"
source_page: "[[redis-sentinel]]"
domain: "database"
risk_level: "high"
...
- **HIGH**: Manages automatic failover; misconfiguration can cause data loss
- **MEDIUM**: Requires proper quorum configuration
- 数据库连接强制使用 TLS 加密
...
**Start Redis Sentinel with config**:
```bash
...
[[redis-sentinel|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
