---
title: "kubectl get csistoragecapacities 生产环境最佳实践"
cmd_name: "kubectl get csistoragecapacities"
cmd_category: "容器编排/K8s存储增强"
source_page: "[[kubectl-get-csistoragecapacities]]"
domain: "container"
risk_level: "low"
platforms: ["linux", "darwin", "windows"]
tags: ["container", "risk-low", "linux", "darwin", "windows"]
created: "2026-07-28"
source_file: "container/k8s/k8s-storage-management.yaml"
---

# kubectl get csistoragecapacities — 生产环境最佳实践
...
| 安装 | kubectl with CSI storage capacity tracking |
...
- **LOW**: Read-only operation; shows storage availability
...
**List storage capacities in production namespace**:
```bash
...
[[kubectl-get-csistoragecapacities|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
