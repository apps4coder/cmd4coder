---
title: "kubectl get storageclass 生产环境最佳实践"
cmd_name: "kubectl get storageclass"
cmd_category: "容器编排/K8s存储增强"
source_page: "[[kubectl-get-storageclass]]"
domain: "container"
risk_level: "low"
...
# kubectl get storageclass — 生产环境最佳实践
...
- **LOW**: Read-only operation; shows storage provisioners
...
[[kubectl-get-storageclass|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
