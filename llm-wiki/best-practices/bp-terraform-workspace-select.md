---
title: "terraform workspace select 生产环境最佳实践"
cmd_name: "terraform workspace select"
cmd_category: "容器编排/K8s配置管理"
source_page: "[[terraform-workspace-select]]"
domain: "container"
risk_level: "medium"
...
# terraform workspace select — 生产环境最佳实践
...
- **MEDIUM**: Changes active workspace; affects state
...
[[terraform-workspace-select|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
