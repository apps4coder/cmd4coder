---
title: "kubectl port-forward svc/grafana 生产环境最佳实践"
cmd_name: "kubectl port-forward svc/grafana"
cmd_category: "容器编排/K8s监控日志"
source_page: "[[kubectl-port-forward-svc-grafana]]"
domain: "container"
risk_level: "medium"
...
# kubectl port-forward svc/grafana — 生产环境最佳实践
...
- **MEDIUM**: Exposes dashboard interface; may contain sensitive data
...
[[kubectl-port-forward-svc-grafana|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
