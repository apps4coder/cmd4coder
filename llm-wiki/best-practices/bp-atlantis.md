---
title: "atlantis 生产环境最佳实践"
cmd_name: "atlantis"
cmd_category: "容器编排/云原生扩展"
source_page: "[[atlantis]]"
domain: "container"
risk_level: "high"
...
| 领域 | `container` |
| 平台 | `linux`, `darwin` |
| 安装 | 参考 https://www.runatlantis.io/docs/installation-guide.html |
...
- **HIGH**: atlantis apply 会修改真实基础设施，请确保 PR 已审查
...
[[atlantis|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
