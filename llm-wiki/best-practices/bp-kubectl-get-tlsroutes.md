---
title: "kubectl get tlsroutes 生产环境最佳实践"
cmd_name: "kubectl get tlsroutes"
cmd_category: "容器编排/K8s网络插件"
source_page: "[[kubectl-get-tlsroutes]]"
domain: "container"
risk_level: "low"
...
# kubectl get tlsroutes — 生产环境最佳实践
...
- **LOW**: Read-only operation; shows TLS routing rules
...
**List TLS routes in production namespace**:
```bash
...
[[kubectl-get-tlsroutes|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
