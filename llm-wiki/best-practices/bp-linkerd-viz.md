---
title: "linkerd viz 生产环境最佳实践"
cmd_name: "linkerd viz"
cmd_category: "网络工具/服务网格"
source_page: "[[linkerd-viz]]"
domain: "network"
risk_level: "low"
...
| 领域 | `network` |
| 平台 | `linux`, `darwin` |
| 安装 | linkerd viz install | kubectl apply -f - |
...
[[linkerd-viz|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
