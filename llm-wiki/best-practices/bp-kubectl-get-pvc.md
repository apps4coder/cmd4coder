---
title: "kubectl get pvc 生产环境最佳实践"
cmd_name: "kubectl get pvc"
cmd_category: "容器编排/K8s存储增强"
source_page: "[[kubectl-get-pvc]]"
domain: "container"
risk_level: "low"
...
- **LOW**: Read-only operation; shows volume claims
...
**List PVCs in production namespace**:
```bash
...
[[kubectl-get-pvc|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
