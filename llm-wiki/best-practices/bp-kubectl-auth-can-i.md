---
title: "kubectl auth can-i 生产环境最佳实践"
cmd_name: "kubectl auth can-i"
cmd_category: "容器编排/K8s安全工具"
source_page: "[[kubectl-auth-can-i]]"
domain: "container"
risk_level: "low"
...
- **LOW**: Read-only permission check; no operational changes
...
**Check deployment creation permission in production**:
```bash
...
[[kubectl-auth-can-i|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
