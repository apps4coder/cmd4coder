---
title: "apt-cache show 生产环境最佳实践"
cmd_name: "apt-cache show"
cmd_category: "操作系统/Ubuntu系统命令"
source_page: "[[apt-cache-show]]"
domain: "system"
risk_level: "low"
platforms: ["linux"]
tags: ["system", "risk-low", "linux"]
created: "2026-07-28"
source_file: "os/ubuntu.yaml"
---

# apt-cache show — 生产环境最佳实践
...
| 领域 | `system` |
| 平台 | `linux` |
| 安装 | Pre-installed on Ubuntu/Debian |
...
**Show detailed nginx package info**:
```bash
...
[[apt-cache-show|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
