---
title: "kubectl get roles 生产环境最佳实践"
cmd_name: "kubectl get roles"
cmd_category: "容器编排/K8s安全工具"
source_page: "[[kubectl-get-roles]]"
domain: "container"
risk_level: "low"
...
- **LOW**: Read-only operation; shows permission mappings
...
**List roles in production namespace**:
```bash
...
[[kubectl-get-roles|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
