---
title: "flux get kustomizations 生产环境最佳实践"
cmd_name: "flux get kustomizations"
cmd_category: "容器编排/K8s持续集成"
source_page: "[[flux-get-kustomizations]]"
domain: "container"
risk_level: "low"
...
# flux get kustomizations — 生产环境最佳实践
...
- **LOW**: Read-only operation; lists resources only
...
**List kustomizations in current namespace**:
```bash
...
[[flux-get-kustomizations|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
