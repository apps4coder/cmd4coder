---
title: "skaffold delete 生产环境最佳实践"
cmd_name: "skaffold delete"
cmd_category: "容器编排/K8s开发调试"
source_page: "[[skaffold-delete]]"
domain: "container"
risk_level: "high"
...
| 安装 | Download from https://skaffold.dev/docs/install/ |
...
- **HIGH**: Deletes application resources from cluster
- **HIGH**: 删除类操作会清理相关资源，建议先确认命名空间、标签选择器和依赖关系。
...
[[skaffold-delete|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
