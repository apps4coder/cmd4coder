---
title: "ctr containers list 生产环境最佳实践"
cmd_name: "ctr containers list"
cmd_category: "容器编排/K8s容器运行时"
source_page: "[[ctr-containers-list]]"
domain: "container"
risk_level: "low"
platforms: ["linux"]
...
- **LOW**: Read-only operation; lists containers only
...
[[ctr-containers-list|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
