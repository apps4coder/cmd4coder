---
title: "kubectl get volumesnapshot 生产环境最佳实践"
cmd_name: "kubectl get volumesnapshot"
cmd_category: "容器编排/K8s存储增强"
source_page: "[[kubectl-get-volumesnapshot]]"
domain: "container"
risk_level: "low"
...
# kubectl get volumesnapshot — 生产环境最佳实践
...
- **LOW**: Read-only operation; shows backup snapshots
...
**List volume snapshots in production namespace**:
```bash
...
[[kubectl-get-volumesnapshot|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
