...
| 安装 | Pre-installed on most Linux; download for Windows |
...
- **MEDIUM**: Downloading from untrusted sources may introduce malware
- **LOW**: Recursive downloads may consume significant disk space
...
[[wget|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
