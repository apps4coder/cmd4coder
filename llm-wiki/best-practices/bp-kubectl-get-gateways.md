---
title: "kubectl get gateways 生产环境最佳实践"
cmd_name: "kubectl get gateways"
cmd_category: "容器编排/K8s网络插件"
source_page: "[[kubectl-get-gateways]]"
domain: "container"
risk_level: "low"
...
- **LOW**: Read-only operation; shows gateway resources
...
**List gateways in production namespace**:
```bash
...
[[kubectl-get-gateways|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
