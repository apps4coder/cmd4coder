...
| 领域 | `cicd` |
| 平台 | `linux`, `darwin` |
| 安装 | brew install act (macOS) 或 curl https://raw.githubusercontent.com/nektos/act/master/install.sh | bash |
...
- **MEDIUM**: 本地执行可能暴露 secrets，注意 .secrets 文件
...
[[act|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
