---
title: "argo-rollouts 生产环境最佳实践"
cmd_name: "argo-rollouts"
cmd_category: "容器编排/云原生扩展二"
source_page: "[[argo-rollouts]]"
domain: "container"
risk_level: "high"
...
| 领域 | `container` |
| 平台 | `linux`, `darwin` |
| 安装 | kubectl krew install argo-rollouts |
...
- **HIGH**: promote/abort 会改变生产流量分布，请确认指标健康
...
[[argo-rollouts|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
