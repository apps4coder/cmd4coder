...
| 领域 | `container` |
| 平台 | `linux`, `darwin` |
| 安装 | 参考 https://github.com/GoogleContainerTools/kaniko |
...
- **MEDIUM**: kaniko 会访问 registry 凭据，请确保 Secret 安全
...
[[kaniko|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
