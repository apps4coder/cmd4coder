---
title: "kafka-consumer-groups 生产环境最佳实践"
cmd_name: "kafka-consumer-groups"
cmd_category: "大数据/流处理"
source_page: "[[kafka-consumer-groups]]"
domain: "general"
risk_level: "high"
...
# kafka-consumer-groups — 生产环境最佳实践
...
- **HIGH**: --reset-offsets --execute 导致消息重复消费或跳过
...
[[kafka-consumer-groups|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
