---
title: "dnf install 生产环境最佳实践"
cmd_name: "dnf install"
cmd_category: "操作系统/CentOS系统命令"
source_page: "[[dnf-install]]"
domain: "system"
risk_level: "medium"
platforms: ["linux"]
...
| 领域 | `system` |
| 平台 | `linux` |
| 安装 | Pre-installed on CentOS 8+/RHEL 8+ |
...
- **MEDIUM**: Installing from untrusted sources may introduce risks
...
[[dnf-install|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
