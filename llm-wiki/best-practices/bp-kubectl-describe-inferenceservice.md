---
title: "kubectl describe inferenceservice 生产环境最佳实践"
cmd_name: "kubectl describe inferenceservice"
cmd_category: "容器编排/K8s机器学习运维"
source_page: "[[kubectl-describe-inferenceservice]]"
domain: "container"
risk_level: "low"
...
# kubectl describe inferenceservice — 生产环境最佳实践
...
**Describe inference service in production namespace**:
```bash
...
[[kubectl-describe-inferenceservice|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
