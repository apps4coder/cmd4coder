---
title: "etcdctl snapshot save 生产环境最佳实践"
cmd_name: "etcdctl snapshot save"
cmd_category: "容器编排/K8s集群管理"
source_page: "[[etcdctl-snapshot-save]]"
domain: "container"
risk_level: "medium"
platforms: ["linux"]
...
# etcdctl snapshot save — 生产环境最佳实践
...
- **LOW**: Read-only backup operation; safe to perform
- **MEDIUM**: Ensure sufficient disk space for snapshot file
...
[[etcdctl-snapshot-save|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
