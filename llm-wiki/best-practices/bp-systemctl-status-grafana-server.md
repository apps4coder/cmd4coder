---
title: "systemctl status grafana-server 生产环境最佳实践"
cmd_name: "systemctl status grafana-server"
cmd_category: "容器编排/K8s监控日志"
source_page: "[[systemctl-status-grafana-server]]"
domain: "container"
risk_level: "medium"
platforms: ["linux"]
...
# systemctl status grafana-server — 生产环境最佳实践
...
- **MEDIUM**: Restarting Grafana disrupts dashboard access
...
[[systemctl-status-grafana-server|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
