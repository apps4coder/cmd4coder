---
title: "helm uninstall 生产环境最佳实践"
cmd_name: "helm uninstall"
cmd_category: "容器编排/K8s Helm包管理"
source_page: "[[helm-uninstall]]"
domain: "container"
risk_level: "critical"
...
- **CRITICAL**: Removes all resources managed by release; causes service downtime
- **HIGH**: Backup data before uninstalling stateful applications
...
**Uninstall from production namespace**:
```bash
...
[[helm-uninstall|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
