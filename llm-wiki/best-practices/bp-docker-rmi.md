---
title: "docker rmi 生产环境最佳实践"
cmd_name: "docker rmi"
cmd_category: "容器编排/Docker命令"
source_page: "[[docker-rmi]]"
domain: "container"
risk_level: "high"
...
- **HIGH**: 会删除容器、镜像或网络资源，生产环境请确认对象并评估依赖影响。
...
- [[bp-docker-images|docker images]]
- [[bp-docker-pull|docker pull]]
- docker system prune
...
[[docker-rmi|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
