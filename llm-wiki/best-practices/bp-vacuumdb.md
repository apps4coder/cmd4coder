---
title: "vacuumdb 生产环境最佳实践"
cmd_name: "vacuumdb"
cmd_category: "数据库工具/PostgreSQL工具"
source_page: "[[vacuumdb]]"
domain: "database"
risk_level: "medium"
...
- **MEDIUM**: Full vacuum locks tables; may impact performance
- **LOW**: Regular vacuum is safe but may take time
- 数据库连接强制使用 TLS 加密
...
[[vacuumdb|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
