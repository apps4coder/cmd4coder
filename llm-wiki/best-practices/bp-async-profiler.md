---
title: "async-profiler 生产环境最佳实践"
cmd_name: "async-profiler"
cmd_category: "诊断工具/性能分析"
source_page: "[[async-profiler]]"
domain: "observability"
risk_level: "low"
platforms: ["linux", "darwin"]
tags: ["observability", "risk-low", "linux", "darwin"]
created: "2026-07-28"
source_file: "diagnostic/profiling.yaml"
---

# async-profiler — 生产环境最佳实践
...
| 领域 | `observability` |
| 平台 | `linux`, `darwin` |
| 安装 | 从 GitHub releases 下载或 brew install async-profiler (macOS) |
...
[[async-profiler|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
