---
title: "calicoctl get networkpolicies 生产环境最佳实践"
cmd_name: "calicoctl get networkpolicies"
cmd_category: "容器编排/K8s网络插件"
source_page: "[[calicoctl-get-networkpolicies]]"
domain: "container"
risk_level: "low"
...
# calicoctl get networkpolicies — 生产环境最佳实践
...
- **LOW**: Read-only operation; lists policies only
...
**List policies in production namespace**:
```bash
...
[[calicoctl-get-networkpolicies|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
