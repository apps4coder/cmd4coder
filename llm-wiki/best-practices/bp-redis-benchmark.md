---
title: "redis-benchmark 生产环境最佳实践"
cmd_name: "redis-benchmark"
cmd_category: "数据库工具/Redis工具"
source_page: "[[redis-benchmark]]"
domain: "database"
risk_level: "medium"
...
- **MEDIUM**: May impact server performance during benchmark
- **LOW**: Creates test data that should be cleaned up
- 数据库连接强制使用 TLS 加密
...
[[redis-benchmark|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
