...
created: "2026-07-28"
source_file: "shell/modern-tools.yaml"
---
...
| 领域 | `shell` |
| 平台 | `linux`, `darwin` |
| 安装 | brew install direnv (macOS) 或 apt install direnv (Ubuntu) |
...
- **MEDIUM**: .envrc 可执行任意 shell 命令，仅 allow 可信目录
...
[[direnv|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
