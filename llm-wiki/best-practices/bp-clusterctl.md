---
title: "clusterctl 生产环境最佳实践"
cmd_name: "clusterctl"
cmd_category: "容器编排/云原生扩展"
source_page: "[[clusterctl]]"
domain: "container"
risk_level: "high"
...
| 领域 | `container` |
| 平台 | `linux`, `darwin` |
| 安装 | 参考 https://cluster-api.sigs.k8s.io/clusterctl/overview.html |
...
- **HIGH**: clusterctl 管理 Kubernetes 集群生命周期，误操作可能影响管理平面
...
[[clusterctl|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
