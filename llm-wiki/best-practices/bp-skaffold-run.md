---
title: "skaffold run 生产环境最佳实践"
cmd_name: "skaffold run"
cmd_category: "容器编排/K8s开发调试"
source_page: "[[skaffold-run]]"
domain: "container"
risk_level: "high"
...
- **HIGH**: Deploys application to cluster
- **MEDIUM**: Verify target namespace before running
...
[[skaffold-run|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
