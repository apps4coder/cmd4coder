...
| 领域 | `container` |
| 平台 | `linux`, `darwin` |
| 安装 | Rook 使用 kubectl 与 CRD 管理，无独立 CLI，可用 kubectl rook-ceph 插件 |
...
- **HIGH**: 直接操作 Ceph 集群会影响存储，请确认命令影响
...
[[rookctl|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
