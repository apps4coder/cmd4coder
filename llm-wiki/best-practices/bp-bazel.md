...
created: "2026-07-28"
source_file: "build-tools/cmake.yaml"
---
...
| 领域 | `build` |
| 平台 | `linux`, `darwin` |
| 安装 | brew install bazelisk (macOS) 或 apt install bazel-bootstrap (Ubuntu) |
...
[[bazel|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
