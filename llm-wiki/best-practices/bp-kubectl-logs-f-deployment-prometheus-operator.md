---
title: "kubectl logs -f deployment/prometheus-operator 生产环境最佳实践"
cmd_name: "kubectl logs -f deployment/prometheus-operator"
cmd_category: "容器编排/K8s监控日志"
source_page: "[[kubectl-logs-f-deployment-prometheus-operator]]"
domain: "container"
risk_level: "low"
...
# kubectl logs -f deployment/prometheus-operator — 生产环境最佳实践
...
- **LOW**: Read-only log viewing; may contain sensitive information
...
**Stream operator logs for real-time monitoring**:
```bash
...
[[kubectl-logs-f-deployment-prometheus-operator|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
