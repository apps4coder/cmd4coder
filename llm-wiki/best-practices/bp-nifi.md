...
| 领域 | `general` |
| 平台 | `linux`, `darwin` |
| 安装 | 参考 https://nifi.apache.org/docs/nifi-docs/html/getting-started.html |
...
- **MEDIUM**: 导入/修改流程会改变数据流转，请在测试环境验证
...
- [[bp-airflow|airflow]]
- [[bp-kafka-connect|kafka-connect]]
...
[[nifi|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
