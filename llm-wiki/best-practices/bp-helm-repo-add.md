---
title: "helm repo add 生产环境最佳实践"
cmd_name: "helm repo add"
cmd_category: "容器编排/K8s Helm包管理"
source_page: "[[helm-repo-add]]"
domain: "container"
risk_level: "low"
...
- **LOW**: Adds repository reference only; verify repository trustworthiness
...
**Add official stable chart repository**:
```bash
...
[[helm-repo-add|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
