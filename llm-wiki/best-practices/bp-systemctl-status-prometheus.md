---
title: "systemctl status prometheus 生产环境最佳实践"
cmd_name: "systemctl status prometheus"
cmd_category: "容器编排/K8s监控日志"
source_page: "[[systemctl-status-prometheus]]"
domain: "container"
risk_level: "medium"
platforms: ["linux"]
...
# systemctl status prometheus — 生产环境最佳实践
...
- **MEDIUM**: Restarting Prometheus causes brief monitoring gap
...
**View Prometheus service status**:
```bash
...
[[systemctl-status-prometheus|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
