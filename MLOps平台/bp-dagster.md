...
| 安装 | pip install dagster dagster-webserver |
...
- **LOW**: dev 模式无认证，生产需部署dagster-webserver并配置RBAC
...
**加载pipeline定义并启动本地UI (localhost:3000)**:
```bash
...
[[dagster|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
