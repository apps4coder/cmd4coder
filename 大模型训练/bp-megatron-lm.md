---
title: "megatron-lm 生产环境最佳实践"
cmd_name: "megatron-lm"
cmd_category: "AI基础设施/大模型训练"
source_page: "[[megatron-lm]]"
domain: "ai-infra"
risk_level: "high"
platforms: ["linux"]
...
| 领域 | `ai-infra` |
| 平台 | `linux` |
| 安装 | git clone https://github.com/NVIDIA/Megatron-LM.git |
...
[[megatron-lm|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
