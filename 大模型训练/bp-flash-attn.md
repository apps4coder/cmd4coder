---
title: "flash-attn 生产环境最佳实践"
cmd_name: "flash-attn"
cmd_category: "AI基础设施/大模型训练"
source_page: "[[flash-attn]]"
domain: "ai-infra"
risk_level: "low"
platforms: ["linux"]
tags: ["ai-infra", "risk-low", "linux"]
created: "2026-07-28"
...
- 安装需要CUDA环境，编译时间较长
- 仅支持Linux，Windows需使用WSL

## 生产示例

**使用Flash Attention 2训练32K长文本**:
```bash
...
[[flash-attn|命令详情]] | [[best-practices-MOC|最佳实践总索引]]
